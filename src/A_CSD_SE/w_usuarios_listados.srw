HA$PBExportHeader$w_usuarios_listados.srw
forward
global type w_usuarios_listados from w_listados
end type
end forward

global type w_usuarios_listados from w_listados
end type
global w_usuarios_listados w_usuarios_listados

on w_usuarios_listados.create
call super::create
end on

on w_usuarios_listados.destroy
call super::destroy
end on
...
*/
cb_ver.event clicked()


end event

type cb_recuperar_pantalla from w_listados`cb_recuperar_pantalla within w_usuarios_listados
end type

type cb_guardar_pantalla from w_listados`cb_guardar_pantalla within w_usuarios_listados
end type

type cb_limpiar from w_listados`cb_limpiar within w_usuarios_listados
end type

type dw_listados_varios from w_listados`dw_listados_varios within w_usuarios_listados
boolean visible = false
end type

type cb_ver from w_listados`cb_ver within w_usuarios_listados
end type

event cb_ver::clicked;string sql, listado,descripcion,id_persona,nom_curso,id_curso
...
type cb_salir from w_listados`cb_salir within w_usuarios_listados
end type

event cb_salir::clicked;//Andr$$HEX1$$e900$$ENDHEX$$s: Ignoramos el script del antecesor
close(parent)
end event

type dw_listados from w_listados`dw_listados within w_usuarios_listados
boolean visible = false
...
type cb_imprimir from w_listados`cb_imprimir within w_usuarios_listados
end type

type cb_zoom from w_listados`cb_zoom within w_usuarios_listados
end type

type cb_esp from w_listados`cb_esp within w_usuarios_listados
end type

type cb_guardar from w_listados`cb_guardar within w_usuarios_listados
end type

type cb_escala from w_listados`cb_escala within w_usuarios_listados
end type

type cb_ordenar from w_listados`cb_ordenar within w_usuarios_listados
end type

type dw_listados_titulo from w_listados`dw_listados_titulo within w_usuarios_listados
end type

type dw_1 from w_listados`dw_1 within w_usuarios_listados
integer width = 3616
string dataobject = "d_usuario_listado"
end type
