HA$PBExportHeader$w_calculo_honorarios_avi.srw
$PBExportComments$Heredada de la ventana de Cuenca
forward
global type w_calculo_honorarios_avi from w_calculo_honorarios
end type
type cb_4 from commandbutton within w_calculo_honorarios_avi
end type
type dw_2 from u_dw within w_calculo_honorarios_avi
end type
end forward
...
global w_calculo_honorarios_avi w_calculo_honorarios_avi
...
on w_calculo_honorarios_avi.create
int iCurrent
call super::create
...
on w_calculo_honorarios_avi.destroy
call super::destroy
destroy(this.cb_4)
destroy(this.dw_2)
end on
...
type cb_recuperar_pantalla from w_calculo_honorarios`cb_recuperar_pantalla within w_calculo_honorarios_avi
integer taborder = 0
end type

type cb_guardar_pantalla from w_calculo_honorarios`cb_guardar_pantalla within w_calculo_honorarios_avi
integer taborder = 0
end type

type cb_3 from w_calculo_honorarios`cb_3 within w_calculo_honorarios_avi
integer x = 1605
integer y = 1708
integer width = 407
integer taborder = 60
...
type cb_2 from w_calculo_honorarios`cb_2 within w_calculo_honorarios_avi
integer y = 1708
integer taborder = 50
end type
...
i_ds_hon.DataObject = 'd_calculo_honorarios_avi'
...
type cb_1 from w_calculo_honorarios`cb_1 within w_calculo_honorarios_avi
integer x = 485
integer y = 1120
integer taborder = 40
...
st_hon.ayuntamiento	= dw_1.getitemstring(1, 'ayuntamiento')

// Calculamos los honorarios
f_calcular_honteor_avi(st_hon)
...
type dw_1 from w_calculo_honorarios`dw_1 within w_calculo_honorarios_avi
event csd_ocultar_campos ( )
integer height = 1596
string dataobject = "d_calculo_honorarios_avi"
end type
...
CHOOSE CASE dwo.name
	CASE 'tarifa'
		event csd_ocultar_campos()
		f_inicializar_valores_st_honteor_dat_avi (parent)
