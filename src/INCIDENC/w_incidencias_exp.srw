HA$PBExportHeader$w_incidencias_exp.srw
forward
global type w_incidencias_exp from w_mant_simple
end type
type st_1 from statictext within w_incidencias_exp
end type
type cb_salir from u_cb within w_incidencias_exp
end type
end forward
...
global w_incidencias_exp w_incidencias_exp

on w_incidencias_exp.create
int iCurrent
call super::create
...
st_1.text= 'Expediente : ' + f_dame_numero_expedi (g_incidencias.id)
...
type dw_1 from w_mant_simple`dw_1 within w_incidencias_exp
integer y = 204
integer width = 2688
integer height = 988
integer taborder = 50
string dataobject = "d_incidencias_exp"
end type
...
dw_1.setitem(dw_1.getrow(),'exp',g_incidencias.id)
...
type cb_anyadir from w_mant_simple`cb_anyadir within w_incidencias_exp
integer taborder = 20
end type

type cb_borrar from w_mant_simple`cb_borrar within w_incidencias_exp
integer taborder = 30
end type

type cb_ayuda from w_mant_simple`cb_ayuda within w_incidencias_exp
