HA$PBExportHeader$w_minutas_recalculo_cip_na.srw
forward
global type w_minutas_recalculo_cip_na from w_sheet
end type
type cb_listado from commandbutton within w_minutas_recalculo_cip_na
end type
type cb_procesar from commandbutton within w_minutas_recalculo_cip_na
end type
type st_proceso from statictext within w_minutas_recalculo_cip_na
end type
type dw_1 from u_dw within w_minutas_recalculo_cip_na
end type
type dw_consulta from u_dw within w_minutas_recalculo_cip_na
end type
type cb_grabar from commandbutton within w_minutas_recalculo_cip_na
end type
type cb_1 from commandbutton within w_minutas_recalculo_cip_na
end type
end forward
...
global w_minutas_recalculo_cip_na w_minutas_recalculo_cip_na
...
on w_minutas_recalculo_cip_na.create
int iCurrent
call super::create
...
on w_minutas_recalculo_cip_na.destroy
call super::destroy
...
//	dw_1.dataobject = 'd_minutas_recalculo_descuentos_cip'
//	dw_1.settransobject(sqlca)
//end if
end event

type cb_recuperar_pantalla from w_sheet`cb_recuperar_pantalla within w_minutas_recalculo_cip_na
integer x = 2619
integer y = 404
integer width = 425
integer height = 92
...
type cb_guardar_pantalla from w_sheet`cb_guardar_pantalla within w_minutas_recalculo_cip_na
integer x = 2619
integer y = 312
integer width = 425
integer height = 92
...
f_sql('f_entrada','>=','f_desde',dw_consulta,sql_nuevo,g_tipo_base_datos,'')
f_sql('f_entrada','<','f_hasta',dw_consulta,sql_nuevo,g_tipo_base_datos,'')
...
//	importe_nuevo = st_cip_datos.cip
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "d_minutas_actualiza_cip_na"
