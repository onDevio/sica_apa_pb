create table dbo._corredurias( agente nvarchar (100) NOT NULL,
cod_postal nvarchar (100) NOT NULL,
...
create table dbo.cer001_copy( cenroint char (7) NOT NULL,
cefecemi datetime NOT NULL,
cefecvis datetime NOT NULL,
cefecent datetime NOT NULL,
cetexto char (70) NOT NULL,
cetipo char (1) NOT NULL,
cedeleg char (1) NOT NULL,
cejecuc decimal NOT NULL,
cenumedi char (3) NOT NULL,
cenuviv char (4) NOT NULL,
cenuvivsb char (4) NOT NULL,
cesutotal char (6) NOT NULL,
cesuviv char (6) NOT NULL,
cesuotr char (6) NOT NULL,
cevalor decimal NOT NULL,
cetiobr decimal NOT NULL,
ceprocesar bit NOT NULL )
...
minimo float NULL,
duda char (1) NULL )
create table dbo.cip_tipo_act( anyo char (4) NOT NULL,
...
create table dbo.coaatmca_coef_b( codigo char (10) NOT NULL,
tipo_act char (3) NULL,
tarifa char (1) NULL,
coef_b char (50) NULL,
f_validez_desde datetime NULL,
f_validez_hasta datetime NULL )
create table dbo.coaatmca_coef_c( codigo char (10) NOT NULL,
...
f_validez_desde datetime NOT NULL,
f_validez_hasta datetime NOT NULL )
create table dbo.coaatmca_coeficientes( codigo char (30) NOT NULL,
f_validez_desde datetime NOT NULL,
f_validez_hasta datetime NOT NULL,
valor_double float NULL )
create table dbo.coaatmca_dv( id char (10) NOT NULL,
...
f_validez_desde datetime NOT NULL,
f_validez_hasta datetime NOT NULL )
create table dbo.coaatmca_fases_estadisticas( id_fases_estadisticas char (10) NOT NULL,
...
create table dbo.colegiados_anexos( id_colegiado_anexo char (10) NOT NULL,
id_colegiado char (10) NOT NULL,
...
empresa char (2) NULL )
create table dbo.csd_conexion_bd( id_conexion varchar (10) NOT NULL,
...
tamanyo float NULL )
create table dbo.csd_seg_ip( id_seg_ip char (10) NOT NULL,
id_usuario char (10) NULL,
tipo_ip varchar (2) NULL,
ip_fija varchar (20) NULL,
ip_rango_a varchar (20) NULL,
ip_rango_b varchar (20) NULL )
create table dbo.csd_seg_ip_exclusion( id_exclusion varchar (10) NOT NULL,
ip_fija varchar (20) NULL,
ip_rango_a varchar (20) NULL,
ip_rango_b varchar (20) NULL )
...
ica float NULL,
otros float NULL )
create table dbo.cuentas_pyme( cuenta nvarchar (10) NOT NULL,
titulo varchar (50) NULL,
resumen nvarchar (15) NULL,
final varchar (1) NULL,
empresa varchar (1) NULL,
...
create table dbo.domicilios_copy( id_domicilio char (10) NOT NULL,
id_colegiado char (10) NOT NULL,
tipo_via char (2) NULL,
nom_via char (100) NULL,
cod_pob char (6) NULL,
...
create table dbo.dv_tipo_act( anyo char (4) NOT NULL,
tipo_actuacion char (2) NOT NULL,
tipo_obra char (2) NOT NULL,
coef_k float NOT NULL )
...
tipo_obra char (3) NOT NULL,
texto_codigos char (50) NULL )
create table dbo.exp_rel( n_registro char (10) NOT NULL,
...
observaciones char (255) NULL )
create table dbo.facturas_a_borrar( id_factura char (10) NOT NULL )
...
create table dbo.fases_clientes2( id_fase char (10) NOT NULL,
id_cliente char (10) NOT NULL,
porcen float NOT NULL,
total_irpf float NULL,
contratista char (1) NULL,
...
reclamar_representante char (1) NULL,
id_propiedad char (10) NULL )
create table dbo.fases_clientes3( id_fase char (10) NOT NULL,
id_cliente char (10) NOT NULL,
porcen float NOT NULL,
total_irpf float NULL,
contratista char (1) NULL,
...
reclamar_representante char (1) NULL,
id_propiedad char (10) NULL )
create table dbo.fases_clientes4( id_fase char (10) NOT NULL,
id_cliente char (10) NOT NULL,
porcen float NOT NULL,
total_irpf float NULL,
contratista char (1) NULL,
...
create table dbo.fases_fact_tmp( id_fase char (10) NOT NULL )
create table dbo.fases_fact_tmp2( id_fase char (10) NOT NULL )
...
id_minuta char (10) NULL )
create table dbo.fases_minutas_copy( id_minuta char (10) NOT NULL,
id_fase char (10) NULL,
id_colegiado char (10) NULL,
id_cliente char (10) NULL,
cantidad float NULL,
...
create table dbo.fases_solo_observaciones( id_fase char (10) NOT NULL,
...
create table dbo.ho_tarifas_contenidos_copy( cod_tarifa char (15) NOT NULL,
cod_contenido char (10) NOT NULL,
minimo float NULL,
coef float NULL,
minimo_cip float NULL )
create table dbo.ho_tarifas_copy( cod_tarifa char (15) NOT NULL,
descripcion char (255) NULL,
formula char (255) NULL,
param1 char (100) NULL,
param2 char (100) NULL,
...
activo char (1) NULL )
create table dbo.meses( cod_mes char (2) NOT NULL,
...
create table dbo.migracion_cf( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_clientes( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_colegiados( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_formaspago( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_iva( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_paises( id_nuevo char (50) NOT NULL,
id_antiguo char (50) NOT NULL )
create table dbo.migracion_poblaciones( id_nuevo char (50) NOT NULL,
id_antiguo char (50) NOT NULL,
id_cp char (50) NOT NULL )
create table dbo.migracion_propietarios( id_nuevo char (50) NOT NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_provincias( id_nuevo char (50) NOT NULL,
id_antiguo char (50) NOT NULL )
create table dbo.migracion_sociedades( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_tiposvia( id_nuevo char (50) NOT NULL,
id_antiguo char (50) NULL )
create table dbo.migracion_vias( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
create table dbo.minutas_nuevas( id_minuta char (10) NOT NULL,
id_fase char (10) NOT NULL )
...
create table dbo.rcv001_copy( rcvvisado char (7) NOT NULL,
rcvnume char (7) NOT NULL,
rcvfecha datetime NOT NULL,
rcvfecob datetime NOT NULL,
rcvcole char (9) NOT NULL,
rcvnombre char (60) NOT NULL,
rcvcuota decimal NOT NULL,
rcvpresu decimal NOT NULL,
rcvestado decimal NOT NULL,
rcvpago decimal NOT NULL,
rcvnrocta char (10) NOT NULL,
rcventidad char (4) NOT NULL,
rcvoficina char (10) NOT NULL,
rcvdc char (2) NOT NULL,
rcvimpo decimal NOT NULL,
rcvcodiva decimal NOT NULL,
rcvdire char (60) NOT NULL,
rcvmuni char (40) NOT NULL,
rcvnif char (20) NOT NULL,
rcvprocesar bit NOT NULL )
create table dbo.reg_apdir( dicod int NOT NULL,
dides char (40) NULL,
dipob int NULL,
dipoi float NULL )
...
texto text NULL,
observaciones text NULL )
create table dbo.retirada_documentacion( id_retirada char (10) NOT NULL,
id_expedi char (10) NOT NULL,
entregado_a char (50) NULL,
f_retirada datetime NULL,
usuario char (10) NULL,
observaciones char (255) NULL )
create table dbo.rpc( n_visado char (10) NOT NULL,
...
cuantia float NULL )
create table dbo.t_laboratorio( codigo char (10) NOT NULL,
descripcion char (50) NULL )
...
coeficiente float NULL,
colegio varchar (10) NULL )
create table dbo.temporal_fases_musaat_movi( id_fase char (10) NULL,
n_contrato_ant char (10) NULL )
create table dbo.temporal_musaat_movimientos( id_movimiento char (10) NULL,
n_contrato_ant char (10) NULL )
