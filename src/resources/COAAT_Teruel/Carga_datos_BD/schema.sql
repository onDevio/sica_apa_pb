...
create table dbo.amoinv( numeroinv varchar (10) NOT NULL,
...
subctaam varchar (12) NULL,
subctado varchar (12) NULL,
importam float NULL,
fecultam datetime NULL,
tpca float NULL,
meses float NULL,
proveedor varchar (12) NULL,
fechafin datetime NULL,
fechabaja datetime NULL,
codbaj varchar (2) NULL,
monedauso varchar (1) NULL,
...
n_apuntes_debe float NOT NULL,
importe_debe char (15) NOT NULL,
n_apuntes_haber float NOT NULL,
...
create table dbo.clientes_poblaciones( id_cliente char (10) NOT NULL,
descripcion char (100) NULL,
cod_pob char (6) NULL,
cod_prov char (6) NULL,
cp char (6) NULL )
create table dbo.clientes_terceros( id char (10) NOT NULL,
id_cliente char (10) NOT NULL,
c_tercero char (2) NOT NULL )
create table dbo.coaatter_deduc_fija( tarifa char (4) NOT NULL,
...
conciliada varchar (2) NULL,
diario varchar (3) NULL,
base_imp float NULL,
...
cta_presupuestaria char (10) NULL,
orden int NULL )
create table dbo.csi_formas_de_pago( tipo_pago varchar (2) NOT NULL,
...
create table dbo.csi_formas_de_pago_correspo( id varchar (10) NOT NULL,
forma_pago_externa varchar (100) NULL,
...
create table dbo.csi_trimestres( id_trimestres varchar (1) NOT NULL,
...
ica float NULL,
otros float NULL )
create table dbo.cuentas_apoyo( cuenta varchar (10) NOT NULL,
titulo varchar (50) NULL,
resumen varchar (15) NULL,
final varchar (1) NULL,
empresa varchar (1) NULL,
debe float NULL,
haber float NULL,
...
id_minuta char (10) NULL )
create table dbo.fases_minutas2( id_minuta char (10) NOT NULL,
id_fase char (10) NULL,
id_colegiado char (10) NULL,
id_cliente char (10) NULL,
cantidad float NULL,
...
id_referencia_web varchar (20) NULL )
create table dbo.fases_poblaciones( anyo char (4) NOT NULL,
contrato char (10) NOT NULL,
cp char (6) NULL,
municipio char (255) NULL,
id_fase char (10) NULL,
cod_pob char (6) NULL,
municipio_depur char (255) NULL )
...
create table dbo.fases_visado( id_fase char (10) NOT NULL,
...
descripcion char (50) NULL )
create table dbo.musaat_cias_aseguradoras( cod_s varchar (2) NOT NULL,
nom_s varchar (25) NULL )
...
zona char (3) NULL )
create table dbo.poblaciones_temp( clave char (8) NOT NULL,
...
cod_colegio varchar (255) NULL,
num_colegio_adscripcion varchar (15) NULL,
tipo char (1) NULL,
apellidos varchar (255) NULL,
poblacion_descripcion varchar (100) NULL,
cod_pob varchar (6) NULL,
...
create table dbo.t_control_eventos2( control char (20) NULL,
evento char (20) NULL,
activo char (1) NULL,
param1 char (50) NULL,
param2 char (50) NULL,
...
coeficiente float NULL,
colegio varchar (10) NULL )
create table dbo.temp_colegiados( ncol char (10) NOT NULL )
create table dbo.temp_fases_asociados( sociedad char (10) NOT NULL,
colegiado char (10) NOT NULL,
part float NULL,
anyo char (4) NULL,
contrato char (10) NULL,
id_fase char (10) NULL )
create table dbo.temp_fases_descuentos( anyo char (4) NOT NULL,
contrato char (10) NOT NULL,
dv float NULL,
cip float NULL,
musaat float NULL,
n_contrato char (10) NULL,
id_fase char (10) NULL )
create table dbo.temp_fases_fin( anyo char (4) NOT NULL,
contrato char (10) NOT NULL,
fecha_fin_s char (10) NULL,
honor_ref_s char (10) NULL,
id_fase char (10) NULL,
fecha_fin datetime NULL,
honor_ref float NULL )
create table dbo.temp_fases_impagadas( anyo char (4) NOT NULL,
contrato char (10) NOT NULL,
fp char (2) NULL,
banco char (2) NULL,
id_fase char (10) NULL )
create table dbo.temp_minutas_reclamaciones( id_minuta char (10) NOT NULL,
f_reclamacion datetime NULL,
tipo_reclamacion char (2) NULL )
...
id_plantilla char (10) NOT NULL,
id_web char (10) NOT NULL,
color_fondo char (7) NOT NULL,
color_fondo_cuadros char (7) NOT NULL,
color_lineas char (7) NOT NULL,
color_texto char (7) NOT NULL,
fuente_texto char (50) NOT NULL,
tamanyo_texto float NOT NULL,
color_texto_menu char (7) NOT NULL,
fuente_texto_menu char (50) NOT NULL,
tamanyo_texto_menu float NOT NULL,
color_texto_titulo char (7) NOT NULL,
fuente_texto_titulo char (50) NOT NULL,
tamanyo_texto_titulo float NOT NULL )
create table dbo.web_paginas( id_pagina char (10) NOT NULL,
id_web char (10) NOT NULL,
texto_menu char (30) NOT NULL,
orden float NOT NULL,
contenido text NOT NULL,
interno char (1) NOT NULL,
