create table dbo.actualiza_dip_descuentos( id_fase char (10) NOT NULL,
n_registro char (15) NOT NULL,
importe_nuevo float NULL,
importe_ant float NULL )
...
ayuda char (255) NULL )
create table dbo.avisos_pendientes_jul08( num_proceso char (15) NOT NULL,
n_aviso char (10) NOT NULL,
visado_tarifa char (20) NOT NULL,
n_visado char (10) NOT NULL,
f_minuta datetime NULL,
total_honor float NULL,
iva_honor float NULL,
importe_ir float NULL,
...
create table dbo.conceptos_domiciliables_sabana( id_colegiado char (10) NOT NULL,
concepto char (10) NOT NULL,
forma_de_pago char (2) NULL,
datos_bancarios char (20) NULL,
nombre_banco char (50) NULL,
...
create table dbo.csi_facturas_recibidas_aux( id_factura char (10) NOT NULL,
n_fact char (15) NOT NULL,
fecha datetime NOT NULL,
nombre char (40) NULL,
domicilio char (40) NULL,
...
incluir_347 char (1) NULL )
create table dbo.csi_lineas_fact_recibidas_aux( id_factura char (10) NULL,
id_linea char (10) NOT NULL,
descripcion char (40) NULL,
subtotal float NULL,
t_iva char (2) NULL,
...
obs char (255) NULL )
create table dbo.csi_proveedores_temp( id_csi_proveedor char (10) NULL,
codigo char (4) NULL,
nombre char (40) NULL,
domicilio char (40) NULL,
...
create table dbo.cuentas_aux( cuenta nvarchar (10) NOT NULL,
...
create table dbo.expedientes_aux( id_expedi char (10) NOT NULL,
n_expedi char (14) NULL,
titulo char (255) NULL,
f_inicio datetime NULL,
cerrado char (1) NULL,
...
valoracion_estim float NULL,
ctrl_calidad_interno char (1) NULL )
create table dbo.expedientes_aux2( id_expedi char (10) NOT NULL,
n_expedi char (14) NULL,
titulo char (255) NULL,
f_inicio datetime NULL,
cerrado char (1) NULL,
...
create table dbo.minutas_repet( id_minuta char (15) NOT NULL,
cont float NOT NULL )
...
create table dbo.reg_apcol( conum int NOT NULL,
cocif char (15) NULL,
conom char (40) NULL,
coap1 char (15) NULL,
coap2 char (15) NULL,
...
cutweb float NULL,
cutmail float NULL )
create table dbo.reg_apcto( ctcto smallint NOT NULL,
ctord smallint NULL,
ctdes char (40) NULL,
ctdim char (40) NULL,
ctmov float NULL,
...
ctco4 char (20) NULL,
ctco5 char (20) NULL )
create table dbo.reg_apprp( prcod int NOT NULL,
prnom char (40) NULL,
prcif char (15) NULL,
prcdi int NULL,
prdir char (40) NULL,
...
prcue char (20) NULL,
prcli int NULL )
create table dbo.reg_apvsi( vsanv smallint NOT NULL,
vsnuv int NOT NULL,
vstav smallint NOT NULL,
vsfec int NOT NULL,
vsfec_com int NOT NULL,
vsnum int NOT NULL,
vsvst smallint NOT NULL,
vscol_1 int NOT NULL,
vssoc_1 int NOT NULL,
vscol_2 int NOT NULL,
vssoc_2 int NOT NULL,
vscol_3 int NOT NULL,
vssoc_3 int NOT NULL,
vscol_4 int NOT NULL,
vssoc_4 int NOT NULL,
vscol_5 int NOT NULL,
vssoc_5 int NOT NULL,
vscol_6 int NOT NULL,
vssoc_6 int NOT NULL,
vscol_7 int NOT NULL,
vssoc_7 int NOT NULL,
vscol_8 int NOT NULL,
vssoc_8 int NOT NULL,
vscol_9 int NOT NULL,
vssoc_9 int NOT NULL,
vscol_10 int NOT NULL,
vssoc_10 int NOT NULL,
vsprp_1 int NOT NULL,
vsprp_2 int NOT NULL,
vsprp_3 int NOT NULL,
vsprp_4 int NOT NULL,
vsprp_5 int NOT NULL,
vsprp_6 int NOT NULL,
vsprp_7 int NOT NULL,
vsprp_8 int NOT NULL,
vsprp_9 int NOT NULL,
vsprp_10 int NOT NULL,
vsobs_1 char (80) NULL,
vsobs_2 char (80) NULL,
vsobs_3 char (80) NULL )
...
descripcion char (255) NULL )
create table dbo.sini_tipo_rec_migra( codigo char (3) NOT NULL,
descripcion char (255) NOT NULL,
grupo char (2) NOT NULL,
cod_migra char (3) NULL )
...
coeficiente float NULL,
colegio varchar (10) NULL )
create table dbo.temp_n_fact( anyo char (10) NOT NULL,
n_col char (10) NOT NULL,
tipo char (10) NULL,
n_fact char (10) NULL )
