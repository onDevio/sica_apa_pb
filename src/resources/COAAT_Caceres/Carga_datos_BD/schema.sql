...
create table dbo.coaatcc_ho_tablas( desde float NOT NULL,
hasta float NOT NULL,
coef float NOT NULL,
limite char (1) NOT NULL,
tarifa char (10) NOT NULL,
contenido char (4) NOT NULL )
create table dbo.coaatcc_ho_tarifas( cod_tarifa char (10) NOT NULL,
descripcion char (255) NULL,
...
create table dbo.coaatcc_ho_tarifas_contenidos( cod_tarifa char (10) NOT NULL,
...
empresa char (2) NOT NULL,
valor float NULL )
create table dbo.csi_fact_imp( id_factura char (15) NOT NULL,
precio float NULL,
iva float NULL,
total float NULL )
...
create table dbo.fases_finales_2( id_fases_final char (10) NOT NULL,
fecha datetime NULL,
descripcion char (255) NULL,
num_viv int NULL,
total_parcial char (1) NULL,
...
id_minuta char (10) NULL )
create table dbo.fases_minutas_filtradas( id_minuta char (10) NOT NULL,
id_fase char (10) NULL,
id_colegiado char (10) NULL,
id_cliente char (10) NULL,
cantidad float NULL,
...
tipo_act_renuncia char (2) NOT NULL,
...
id_antiguo char (50) NULL )
create table dbo.migracion_paises( id_nuevo char (50) NULL,
id_antiguo char (50) NULL )
...
id_antiguo char (50) NULL )
create table dbo.migracion_tiposvia( id_antiguo char (50) NOT NULL,
id_nuevo char (50) NOT NULL )
...
fecha datetime NULL,
tipo_reclamacion char (2) NULL )
create table dbo.renuncias_copy( id_renuncia char (20) NOT NULL,
n_renuncia numeric (7, 0) identity  )
...
coeficiente float NULL,
colegio varchar (10) NULL )
create table dbo.temp_contrato_tipoint( id_contrato varchar (10) NOT NULL,
num_contrato varchar (10) NULL,
fecha_contrato datetime NULL,
sede varchar (1) NULL,
descripcion varchar (150) NULL,
id_tipoint varchar (3) NULL,
descripcion2 varchar (150) NULL,
tipoint varchar (3) NULL,
id_fase varchar (10) NULL )
create table dbo.temp_contratos_anyo( id_contrato char (10) NOT NULL,
fecha datetime NOT NULL,
anyo char (2) NULL )
create table dbo.temp_pobla( id_contrato char (15) NOT NULL,
cp char (10) NULL,
descripcion char (70) NULL,
id_pobla char (50) NULL,
id_pobla_nuevo char (10) NULL )
create table dbo.temp_pobla_backup( id_fase char (15) NOT NULL,
poblacion char (15) NULL )
create table dbo.temp_viviendas( id_contrato char (20) NOT NULL,
num_contrato char (20) NULL,
fecha_contrato datetime NULL,
num_viv float NULL,
superficie float NULL,
altura float NULL,
id_fase char (15) NULL )
...
total float NULL )
create table dbo.tmp_dni( nif char (10) NOT NULL,
id_colegiado char (10) NULL,
importe float NULL,
id_factura char (10) NULL,
id_linea char (10) NULL )
