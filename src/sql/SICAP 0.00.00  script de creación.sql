...
declare @pages int
select @pages = (     56184 / @mbpp) + 0.5
declare @dbn varchar(30)
select @dbn = db_name()
if @res != 0 return
exec @res = sp_addthreshold sicap_mallorca, 'logsegment',       56184 ,'sp_thresholdaction'
go
...
observaciones	text	null,
constraint id_prestamo PRIMARY KEY  NONCLUSTERED ( r_g)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.caja_pagos (
id_caja_pagos	char(10)	not null,
fecha	datetime	null,
importe	float	null,
observaciones	char(255)	null,
centro	char(10)	null,
...
constraint caja_pagos_x PRIMARY KEY  NONCLUSTERED ( id_caja_pagos)
)
on 'default'
go
...
constraint cip_tablas_copy_x PRIMARY KEY  NONCLUSTERED ( desde,hasta,tarifa)
)
on 'default'
go
...
minimo	float	null,
duda	char(1)	null,
constraint cip_tarifa_copy_x PRIMARY KEY  NONCLUSTERED ( tipo_actuacion,tipo_obra)
)
on 'default'
go
...
hasta	float	null,
cuota	char(100)	null,
f_validez_desde	datetime	not null,
f_validez_hasta	datetime	not null,
constraint pk_dv PRIMARY KEY  NONCLUSTERED ( id)
)
on 'default'
go
...
SETUSER
go
print    'coaatmca_coef_b'
SETUSER 'dbo'
go
create table dbo.coaatmca_coef_b (
codigo	char(10)	not null,
tipo_act	char(3)	null,
tarifa	char(1)	null,
coef_b	char(50)	null,
f_validez_desde	datetime	null,
f_validez_hasta	datetime	null,
constraint pk_coef_b PRIMARY KEY  CLUSTERED ( codigo)
)
on 'default'
go
...
SETUSER
go
print    'coaatmca_coef_c'
SETUSER 'dbo'
go
create table dbo.coaatmca_coef_c (
codigo	char(10)	not null,
rango_inf	float	not null,
rango_sup	float	not null,
coef_c	char(50)	not null,
tarifa	char(1)	not null,
f_validez_desde	datetime	not null,
f_validez_hasta	datetime	not null,
constraint pk_coef_c PRIMARY KEY  CLUSTERED ( codigo)
)
on 'default'
go
...
SETUSER
go
print    'coaatmca_coeficientes'
SETUSER 'dbo'
go
create table dbo.coaatmca_coeficientes (
codigo	char(30)	not null,
f_validez_desde	datetime	not null,
f_validez_hasta	datetime	not null,
valor_double	float	null,
constraint pk_cod PRIMARY KEY  CLUSTERED ( codigo,f_validez_desde,f_validez_hasta)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.coaatmca_dv (
id	char(10)	not null,
tipo_intervencion	char(3)	null,
pem_desde	float	null,
pem_hasta	float	null,
cuota	char(100)	null,
f_validez_desde	datetime	not null,
f_validez_hasta	datetime	not null,
constraint pk_dv PRIMARY KEY  CLUSTERED ( id)
)
on 'default'
go
...
SETUSER
go
print    'coaatmca_fases_estadisticas'
SETUSER 'dbo'
go
create table dbo.coaatmca_fases_estadisticas (
id_fases_estadisticas	char(10)	not null,
id_fase	char(10)	not null,
sup_parcela	float	null,
cc_hormigon	char(1)	null,
cc_hormigon_tipo	char(1)	null,
cc_acero	char(1)	null,
cc_acero_tipo	char(1)	null,
cc_forjados	char(1)	null,
cc_muro_carga	char(1)	null,
cc_cubiertas	char(1)	null,
tipologia	char(1)	null,
f_visado_pb	datetime	null,
f_visado_pe	datetime	null,
n_visado_pb	char(15)	null,
n_visado_pe	char(15)	null,
cod_lab	char(2)	null,
constraint pk_fases_estad PRIMARY KEY  CLUSTERED ( id_fases_estadisticas)
)
on 'default'
go
print   'id_fase'
create nonclustered index id_fase
on dbo.coaatmca_fases_estadisticas (id_fase)
on 'default'
go
...
SETUSER
go
print    'coaatmca_tipologia_edif'
SETUSER 'dbo'
go
create table dbo.coaatmca_tipologia_edif (
codigo	char(2)	not null,
descripcion	char(255)	null,
valor	float	null,
constraint pk_tipologia PRIMARY KEY  CLUSTERED ( codigo)
)
on 'default'
go
...
print   'n_consejo'
create nonclustered index n_consejo
on dbo.colegiados (n_consejo)
on 'default'
go
...
constraint conceptos_domiciliables_x PRIMARY KEY  NONCLUSTERED ( id_colegiado,concepto,empresa)
)
on 'default'
go
...
SETUSER
go
print    'csi_aeat_registro_contador'
SETUSER 'dbo'
go
create table dbo.csi_aeat_registro_contador (
id_declaracion	varchar(10)	not null,
...
constraint pk_csi_aeat_registro_contador PRIMARY KEY  NONCLUSTERED ( id_declaracion)
)
on 'default'
go
...
SETUSER
go
print    'csi_apuntes_borrados_fe'
SETUSER 'dbo'
go
create table dbo.csi_apuntes_borrados_fe (
id_apunte	varchar(10)	not null,
...
constraint csi_apuntes_borrados_fe PRIMARY KEY  NONCLUSTERED (id_apunte)
)
on 'default'
go
...
constraint csi_articulos_servicios_x PRIMARY KEY  NONCLUSTERED ( codigo,colegio,empresa)
)
on 'default'
go
...
SETUSER
go
print    'csi_articulos_servicios2'
SETUSER 'dbo'
go
create table dbo.csi_articulos_servicios2 (
codigo	char(10)	not null,
descripcion	text	null,
familia	char(2)	null,
cuenta	char(10)	null,
...
cta_gasto	char(10)	null,
regularizar	char(1)	null,
constraint csi_articulos_servicios2_x PRIMARY KEY  NONCLUSTERED ( codigo,colegio,empresa)
)
on 'default'
go
...
SETUSER
go
print    'csi_balances_etcpn_columnas'
SETUSER 'dbo'
go
create table dbo.csi_balances_etcpn_columnas (
id_col	varchar(10)	not null,
...
constraint pk_csi_balances_etcpn_columnas PRIMARY KEY  NONCLUSTERED ( id_col)
)
on 'default'
go
...
constraint csi_bancos_copy_x PRIMARY KEY  NONCLUSTERED ( codigo,empresa)
)
on 'default'
go
...
SETUSER
go
print    'csi_centros_intragrupo'
SETUSER 'dbo'
go
create table dbo.csi_centros_intragrupo (
codigo	char(3)	not null,
empresa	varchar(2)	null,
cuenta	varchar(10)	null,
centro	varchar(3)	null,
...
ejercicio	char(4)	not null,
empresa	char(2)	not null,
constraint csi_control_ejercicios_copy_x PRIMARY KEY  NONCLUSTERED ( ejercicio,empresa)
)
on 'default'
go
...
constraint csi_ejercicios_abiertos_copy_x PRIMARY KEY  NONCLUSTERED ( ejercicio,empresa)
)
on 'default'
go
...
SETUSER
go
print    'csi_elems_inmov_grupo'
SETUSER 'dbo'
go
create table dbo.csi_elems_inmov_grupo (
...
constraint pk_csi_elems_inmov_grupo PRIMARY KEY  CLUSTERED ( cod_grupo)
)
on 'default'
go
...
SETUSER
go
print    'csi_elems_inmov_tipo_baja'
SETUSER 'dbo'
go
create table dbo.csi_elems_inmov_tipo_baja (
cod_tipo_baja	varchar(2)	not null,
descripcion	varchar(100)	not null,
constraint pk_csi_elems_inmov_tipo_baja PRIMARY KEY  CLUSTERED ( cod_tipo_baja)
)
on 'default'
go
...
SETUSER
go
print    'csi_elems_inmov_tipo_natura'
SETUSER 'dbo'
go
create table dbo.csi_elems_inmov_tipo_natura (
cod_tipo_natura	varchar(2)	not null,
descripcion	varchar(100)	not null,
constraint pk_csi_elems_inmov_tipo_natura PRIMARY KEY  CLUSTERED ( cod_tipo_natura)
)
on 'default'
go
...
SETUSER
go
print    'csi_elems_inmov_ubicacion'
SETUSER 'dbo'
go
create table dbo.csi_elems_inmov_ubicacion (
cod_ubicacion	varchar(5)	not null,
descripcion	varchar(100)	null,
notas	varchar(100)	null,
notas_adic	varchar(100)	null,
constraint pk_csi_elems_inmov_ubicacion PRIMARY KEY  CLUSTERED ( cod_ubicacion)
)
on 'default'
go
...
devolucion_mensual	char(1)	null,
banco_defecto	char(10)	null,
web	varchar(100)	null,
email	varchar(100)	null,
constraint csi_empresas_x PRIMARY KEY  NONCLUSTERED ( codigo)
)
on 'default'
go
...
ciclo	int	null,
constraint csi_fact_reclamaciones_tipos PRIMARY KEY  NONCLUSTERED (tipo_reclamacion )
)
on 'default'
go
...
proforma	char(1)	DEFAULT  'N' NULL	null,
paga_empresa	varchar(1)	null,
paga_externo	varchar(1)	null,
imprime_cta_banco_col	varchar(1)	null,
...
print   'i_id_persona'
create nonclustered index i_id_persona
on dbo.csi_facturas_emitidas (id_persona)
on 'default'
go
...
print   'n_fact'
create nonclustered index n_fact
on dbo.csi_facturas_emitidas (n_fact)
on 'default'
go
...
print   'tipo_factura'
create nonclustered index tipo_factura
on dbo.csi_facturas_emitidas (tipo_factura)
on 'default'
go
...
constraint csi_facturas_recibidas_copy_x PRIMARY KEY  NONCLUSTERED ( id_factura)
)
on 'default'
go
...
go
print   'id_fact'
create nonclustered index id_fact
...
SETUSER
go
print    'csi_log_apuntes'
SETUSER 'dbo'
go
create table dbo.csi_log_apuntes (
id_log_apuntes	varchar(10)	not null,
empresa	varchar(2)	null,
anyo	varchar(4)	null,
...
f_generacion	datetime	null,
constraint pk_csi_log_apuntes PRIMARY KEY  NONCLUSTERED ( id_log_apuntes)
)
on 'default'
go
...
n_remesa	char(10)	null,
constraint csi_pagos_copy_x PRIMARY KEY  NONCLUSTERED ( id_pago)
)
on 'default'
go
...
SETUSER
go
print    'csi_param_facturas'
SETUSER 'dbo'
go
create table dbo.csi_param_facturas (
serie	char(10)	DEFAULT  "%" 	not null,
empresa	char(2)	DEFAULT  "%" 	not null,
anyo	char(4)	DEFAULT  "%" 	not null,
idioma	char(2)	DEFAULT  "%" 	not null,
campo	char(20)	not null,
texto	text	null,
constraint csi_param_factura_x PRIMARY KEY  NONCLUSTERED ( serie,empresa,anyo,campo,idioma)
)
on 'default'
go
...
SETUSER
go
print    'csi_proforma_a_factura'
SETUSER 'dbo'
go
create table dbo.csi_proforma_a_factura (
id_factura	char(10)	not null,
...
banco	char(10)	null,
contabilizada_proforma	char(1)	DEFAULT  'N' null	null,
f_conta_proforma	datetime	null,
anulada_proforma	char(1)	DEFAULT  'N' null	null,
constraint csi_proforma_a_factura PRIMARY KEY  NONCLUSTERED (id_factura)
)
on 'default'
go
...
porcent_reten_adic	float	null,
cuenta_reten_adic	char(10)	null,
constraint csi_proveedores_copy_x PRIMARY KEY  NONCLUSTERED ( id_proveedor)
)
on 'default'
go
...
empresa	char(2)	not null,
activo	char(1)	null,
constraint csi_proyectos_copy_x PRIMARY KEY  NONCLUSTERED ( proyecto,empresa)
)
on 'default'
go
...
proforma	char(1)	DEFAULT  'N' NULL	null,
serie_por_defecto	char(1)	DEFAULT  'N' null	null,
...
dataobject	char(100)	null,
tipo	char(1)	null,
constraint csi_series_x PRIMARY KEY  NONCLUSTERED ( serie,anyo)
)
on 'default'
go
...
go
print   'i_final'
create nonclustered index i_final
on dbo.cuentas (final)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.cursos_ferias (
id_cf	int	not null,
tipo	char(10)	null,
titulo	char(255)	null,
organizador	char(255)	null,
fecha_unidia	datetime	null,
fecha_desde	datetime	null,
fecha_hasta	datetime	null,
precio	float	null,
ciudad	char(50)	null,
pais	char(50)	null,
inscripciones	char(255)	null,
portada_web	char(1)	null,
constraint x_cf PRIMARY KEY  NONCLUSTERED ( id_cf)
)
on 'default'
go
...
SETUSER
go
print    'cursos_general'
SETUSER 'dbo'
go
create table dbo.cursos_general (
colegiado	char(10)	not null,
apellidos	char(80)	null,
nombre	char(50)	null,
es_colegiado	char(1)	null,
constraint p_k PRIMARY KEY  NONCLUSTERED ( colegiado)
)
on 'default'
go
...
constraint est_tipo_act_copy_x PRIMARY KEY  NONCLUSTERED ( tipo_act)
)
on 'default'
go
...
texto_codigos	char(50)	null,
constraint est_tipo_act_tipo_obra_f PRIMARY KEY  NONCLUSTERED (tipo_act)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.exp_rel (
n_registro	char(10)	not null,
id_expedi	char(10)	null,
n_expedi	char(10)	null,
nuevo_id_exp	char(10)	null,
nuevo_n_exp	char(10)	null,
constraint n_reg PRIMARY KEY  CLUSTERED ( n_registro)
)
on 'default'
go
...
constraint expedientes_copy_x PRIMARY KEY  NONCLUSTERED ( id_expedi)
)
on 'default'
go
print   'n_expedi'
...
SETUSER
go
print    'expedientes_estado_temporal'
SETUSER 'dbo'
go
create table dbo.expedientes_estado_temporal (
...
SETUSER
go
print    'facturas_a_borrar'
SETUSER 'dbo'
go
create table dbo.facturas_a_borrar (
id_factura	char(10)	not null,
constraint pk PRIMARY KEY  CLUSTERED ( id_factura)
)
on 'default'
go
...
go
print   'f_entrada'
create nonclustered index f_entrada
on dbo.fases (f_entrada)
on 'default'
go

print   'id_expedi'
create nonclustered index id_expedi
on dbo.fases (id_expedi)
on 'default'
go

print   'n_expedi'
create nonclustered index n_expedi
on dbo.fases (n_expedi)
on 'default'
go

print   'n_registro'
create nonclustered index n_registro
on dbo.fases (n_registro)
on 'default'
go

print   'n_visado'
create nonclustered index n_visado
on dbo.fases (archivo)
on 'default'
go
...
go
print   'i_id_fase'
create nonclustered index i_id_fase
...
go
print   'id_cli'
create nonclustered index id_cli
...
SETUSER
go
print    'fases_clientes2'
SETUSER 'dbo'
go
create table dbo.fases_clientes2 (
id_fase	char(10)	not null,
id_cliente	char(10)	not null,
porcen	float	not null,
total_irpf	float	null,
...
reclamar_representante	char(1)	null,
id_propiedad	char(10)	null,
constraint pk_fases_clientes2 PRIMARY KEY  NONCLUSTERED ( id_fase,id_cliente)
)
on 'default'
go
...
SETUSER
go
print    'fases_clientes3'
SETUSER 'dbo'
go
create table dbo.fases_clientes3 (
id_fase	char(10)	not null,
id_cliente	char(10)	not null,
porcen	float	not null,
total_irpf	float	null,
...
reclamar_representante	char(1)	null,
id_propiedad	char(10)	null,
constraint pk_fases_clientes3 PRIMARY KEY  NONCLUSTERED ( id_fase,id_cliente)
)
on 'default'
go
...
SETUSER
go
print    'fases_clientes4'
SETUSER 'dbo'
go
create table dbo.fases_clientes4 (
id_fase	char(10)	not null,
id_cliente	char(10)	not null,
porcen	float	not null,
total_irpf	float	null,
...
reclamar_representante	char(1)	null,
id_propiedad	char(10)	null,
constraint pk_fases_clientes4 PRIMARY KEY  NONCLUSTERED ( id_fase,id_cliente)
)
on 'default'
go
...
print   'id_fase_col'
create nonclustered index id_fase_col
on dbo.fases_colegiados (id_fase, id_col)
on 'default'
go
...
SETUSER
go
print    'fases_contratistas'
SETUSER 'dbo'
go
create table dbo.fases_contratistas (
codigo	float	not null,
id_fase	char(10)	not null,
observaciones	char(255)	null,
constraint fases_x PRIMARY KEY  NONCLUSTERED ( codigo)
)
on 'default'
go
...
SETUSER
go
print    'fases_fact_tmp'
SETUSER 'dbo'
go
create table dbo.fases_fact_tmp (
id_fase	char(10)	not null,
constraint pk_id PRIMARY KEY  CLUSTERED ( id_fase)
)
on 'default'
go
...
SETUSER
go
print    'fases_fact_tmp2'
SETUSER 'dbo'
go
create table dbo.fases_fact_tmp2 (
id_fase	char(10)	not null,
constraint pk_id PRIMARY KEY  CLUSTERED ( id_fase)
)
on 'default'
...
empresa	char(2)	null,
constraint fases_informes PRIMARY KEY  NONCLUSTERED (id_fase,id_informe,tipo_informe)
)
on 'default'
go
print   'id_fase'
...
SETUSER
go
print    'fases_informes2'
SETUSER 'dbo'
go
create table dbo.fases_informes2 (
id_fase	char(10)	not null,
id_informe	char(10)	not null,
tipo_informe	char(10)	not null,
cuantia_cliente	float	null,
...
print   'id_fase'
create nonclustered index id_fase
on dbo.fases_informes2 (id_fase)
on 'default'
go
...
go
print   'i_estado'
create nonclustered index i_estado
...
print   'n_aviso'
create nonclustered index n_aviso
on dbo.fases_minutas (n_aviso)
on 'default'
go
...
obra_iniciada	char(1)	DEFAULT  'N' null	null,
...
SETUSER
go
print    'fases_solo_observaciones'
SETUSER 'dbo'
go
create table dbo.fases_solo_observaciones (
id_fase	char(10)	not null,
archivo	char(15)	null,
observaciones	text	null
)
on 'default'
go
...
constraint fases_usos PRIMARY KEY  NONCLUSTERED (id_uso, id_fase)
)
on 'default'
go
print   'id_fase'
...
constraint pk_id PRIMARY KEY  NONCLUSTERED ( id_fase,cod_uso)
)
on 'default'
go
...
SETUSER
go
print    'formacion_areas_materias'
SETUSER 'dbo'
go
create table dbo.formacion_areas_materias (
codigo	char(2)	not null,
descripcion	char(255)	null,
constraint codigo_x PRIMARY KEY  NONCLUSTERED ( codigo)
)
...
SETUSER
go
print    'formacion_areas_materias_curso'
SETUSER 'dbo'
go
create table dbo.formacion_areas_materias_curso (
id_curso	char(10)	not null,
codigo	char(2)	not null,
tipo	char(1)	null,
constraint curso_area_materia_x PRIMARY KEY  NONCLUSTERED ( id_curso,codigo)
)
on 'default'
go
...
SETUSER
go
print    'formacion_asist_fecha'
SETUSER 'dbo'
go
create table dbo.formacion_asist_fecha (
id_asistencia_fecha	char(10)	not null,
id_curso	char(10)	null,
fecha	datetime	null,
constraint formacion_asist_fecha_x PRIMARY KEY  NONCLUSTERED ( id_asistencia_fecha)
)
on 'default'
go
...
SETUSER
go
print    'formacion_asistentes'
SETUSER 'dbo'
go
create table dbo.formacion_asistentes (
...
cod_titulacion	nvarchar(3)	null,
observaciones	text	null,
pagador	char(1)	null,
constraint formacion_asistentes_copy_x PRIMARY KEY  NONCLUSTERED ( id_asistente)
)
on 'default'
go
...
SETUSER
go
print    'formacion_asistentes_test'
SETUSER 'dbo'
go
create table dbo.formacion_asistentes_test (
id_encuesta	char(10)	not null,
id_asistente	char(10)	null,
id_pregunta	char(10)	null,
id_curso	char(10)	null,
id_respuesta_test	char(10)	null,
respuesta	text	null,
constraint formacion_asistentes_test_x PRIMARY KEY  NONCLUSTERED ( id_encuesta)
)
on 'default'
go
...
SETUSER
go
print    'formacion_campos_encuesta'
SETUSER 'dbo'
go
create table dbo.formacion_campos_encuesta (
id_campo	char(10)	not null,
id_pregunta	char(10)	null,
campo	char(2)	null,
evalua	char(1)	null,
constraint formacion_campos_encuesta PRIMARY KEY  NONCLUSTERED (id_campo)
)
on 'default'
go
...
SETUSER
go
print    'formacion_costes'
SETUSER 'dbo'
go
create table dbo.formacion_costes (
id_coste	char(10)	not null,
id_curso	char(10)	null,
descripcion	char(255)	null,
importe	decimal(18, 2)	null,
constraint formacion_costes_x PRIMARY KEY  NONCLUSTERED ( id_coste)
)
on 'default'
go
...
SETUSER
go
print    'formacion_ctrl_asistencia'
SETUSER 'dbo'
go
create table dbo.formacion_ctrl_asistencia (
id_asistencia	char(10)	not null,
id_asistente	char(10)	null,
id_curso	char(10)	null,
asiste	char(1)	null,
id_asistencia_fecha	char(10)	null,
constraint formacion_ctrl_asistencia_x PRIMARY KEY  NONCLUSTERED ( id_asistencia)
)
on 'default'
go
...
SETUSER
go
print    'formacion_cursos'
SETUSER 'dbo'
go
create table dbo.formacion_cursos (
id_curso	char(10)	not null,
codigo	char(15)	null,
anyo	char(5)	null,
nombre	char(255)	null,
...
subtipo_convocatoria	char(3)	null,
id_curso_interno	char(10)	null,
cod_pob	char(6)	null,
cp	char(6)	null,
...
constraint formacion_cursos_x PRIMARY KEY  NONCLUSTERED ( id_curso)
)
on 'default'
go
...
SETUSER
go
print    'formacion_dirigido_a'
SETUSER 'dbo'
go
create table dbo.formacion_dirigido_a (
codigo	char(3)	not null,
descripcion	char(60)	null,
constraint pk PRIMARY KEY  NONCLUSTERED ( codigo)
)
...
SETUSER
go
print    'formacion_documentacion'
SETUSER 'dbo'
go
create table dbo.formacion_documentacion (
id_documento	char(10)	not null,
id_curso	char(10)	null,
documento	char(255)	null,
nombre_documento	char(100)	null,
autor	char(100)	null,
constraint formacion_documentacion_x PRIMARY KEY  NONCLUSTERED ( id_documento)
)
on 'default'
go
...
SETUSER
go
print    'formacion_encuesta'
SETUSER 'dbo'
go
create table dbo.formacion_encuesta (
id_pregunta	char(10)	not null,
id_curso	char(10)	null,
...
respuesta	text	null,
n_pregunta	int	null,
codigo_original	varchar(10)	null,
simple	varchar(1)	null,
afecta_a	varchar(10)	null,
constraint formacion_encuesta_x PRIMARY KEY  NONCLUSTERED ( id_pregunta)
)
on 'default'
go
...
SETUSER
go
print    'formacion_estadisticas'
SETUSER 'dbo'
go
create table dbo.formacion_estadisticas (
id_estadistica	char(10)	not null,
id_curso	char(10)	null,
n_pregunta	int	null,
...
constraint formacion_estadisticas_x PRIMARY KEY  NONCLUSTERED ( id_estadistica)
)
on 'default'
go
...
SETUSER
go
print    'formacion_estados'
SETUSER 'dbo'
go
create table dbo.formacion_estados (
cod_estado	char(2)	not null,
descripcion	char(25)	null,
constraint pk_formacion_estados PRIMARY KEY  NONCLUSTERED ( cod_estado)
)
on 'default'
go
...
SETUSER
go
print    'formacion_fechas'
SETUSER 'dbo'
go
create table dbo.formacion_fechas (
id_curso_fechas	char(10)	not null,
id_curso	char(10)	null,
fecha	datetime	null,
hora_ini	datetime	null,
hora_fin	datetime	null,
constraint formacion_fechas_x PRIMARY KEY  NONCLUSTERED ( id_curso_fechas)
)
on 'default'
go
...
SETUSER
go
print    'formacion_formapago'
SETUSER 'dbo'
go
create table dbo.formacion_formapago (
cod_fp	char(2)	not null,
descripcion	char(60)	null,
constraint pk PRIMARY KEY  NONCLUSTERED ( cod_fp)
)
on 'default'
go
...
SETUSER
go
print    'formacion_importe'
SETUSER 'dbo'
go
create table dbo.formacion_importe (
id_importe	char(10)	not null,
id_curso	char(10)	null,
nombre	char(50)	null,
importe	real	null,
constraint formacion_importe_x PRIMARY KEY  NONCLUSTERED ( id_importe)
)
on 'default'
go
...
SETUSER
go
print    'formacion_mant_preguntas'
SETUSER 'dbo'
go
create table dbo.formacion_mant_preguntas (
codigo	char(10)	not null,
pregunta	char(60)	null,
simple	char(1)	null,
constraint codigo PRIMARY KEY  NONCLUSTERED ( codigo)
)
on 'default'
...
SETUSER
go
print    'formacion_mant_test'
SETUSER 'dbo'
go
create table dbo.formacion_mant_test (
id_respuesta_test	char(10)	not null,
respuesta_test	char(60)	null,
valor_respuesta	int	null,
constraint formacion_mant_test_x PRIMARY KEY  NONCLUSTERED ( id_respuesta_test)
)
on 'default'
go
...
SETUSER
go
print    'formacion_materias_curso'
SETUSER 'dbo'
go
create table dbo.formacion_materias_curso (
id_cursos_materias	char(10)	not null,
id_curso	char(10)	null,
materia	char(2)	null,
constraint curso_area_materia_x PRIMARY KEY  NONCLUSTERED ( id_cursos_materias)
)
on 'default'
go
...
SETUSER
go
print    'formacion_organizadores'
SETUSER 'dbo'
go
create table dbo.formacion_organizadores (
id_organizador	char(10)	not null,
id_curso	char(10)	null,
nombre	char(100)	null,
direccion	char(60)	null,
...
constraint formacion_organizadores_x PRIMARY KEY  NONCLUSTERED ( id_organizador)
)
on 'default'
go
...
SETUSER
go
print    'formacion_organizadores_curso'
SETUSER 'dbo'
go
create table dbo.formacion_organizadores_curso (
id_organizador_curso	char(10)	not null,
id_organizador	char(10)	null,
id_curso	char(10)	null,
persona_contacto	char(100)	null,
inscripciones	char(1)	null,
rol	char(1)	null,
constraint pk PRIMARY KEY  NONCLUSTERED ( id_organizador_curso)
)
on 'default'
go
...
SETUSER
go
print    'formacion_ponente_curso'
SETUSER 'dbo'
go
create table dbo.formacion_ponente_curso (
id_curso_ponente	char(10)	not null,
id_curso	char(10)	null,
...
constraint formacion_ponente_curso_x PRIMARY KEY  NONCLUSTERED ( id_curso_ponente)
)
on 'default'
go
...
SETUSER
go
print    'formacion_ponentes'
SETUSER 'dbo'
go
create table dbo.formacion_ponentes (
id_ponente	char(10)	not null,
nif	char(15)	null,
nombre	char(50)	null,
apellidos	char(80)	null,
...
fax	char(12)	null,
email	char(50)	null,
constraint formacion_ponentes_x PRIMARY KEY  NONCLUSTERED ( id_ponente)
)
on 'default'
go
...
SETUSER
go
print    'formacion_preinscrito'
SETUSER 'dbo'
go
create table dbo.formacion_preinscrito (
id_preinscrito	char(10)	not null,
id_asistente	char(10)	null,
id_curso	char(10)	null,
nombre	char(60)	null,
apellidos	char(100)	null,
constraint formacion_preinscrito PRIMARY KEY  NONCLUSTERED (id_preinscrito)
)
on 'default'
go
...
SETUSER
go
print    'formacion_programa'
SETUSER 'dbo'
go
create table dbo.formacion_programa (
id_formacion_programa	char(10)	not null,
id_curso	char(10)	null,
fecha	datetime	null,
hora	datetime	null,
titulo	char(255)	null,
contenido	text	null,
id_curso_ponente	char(10)	null,
incluir_web	char(1)	null,
constraint pk PRIMARY KEY  NONCLUSTERED ( id_formacion_programa)
)
on 'default'
go
...
SETUSER
go
print    'formacion_subtipo_conv'
SETUSER 'dbo'
go
create table dbo.formacion_subtipo_conv (
cod_subtipo	nvarchar(3)	not null,
descripcion	nvarchar(150)	null,
cod_tipo	nvarchar(1)	null,
constraint cod_subtipo PRIMARY KEY  NONCLUSTERED ( cod_subtipo)
)
on 'default'
go
...
SETUSER
go
print    'formacion_test'
SETUSER 'dbo'
go
create table dbo.formacion_test (
id_pregunta	char(10)	not null,
id_curso	char(10)	null,
pregunta	char(255)	null,
tipo_respuesta	char(1)	null,
...
SETUSER
go
print    'formacion_tipo_asistente'
SETUSER 'dbo'
go
create table dbo.formacion_tipo_asistente (
codigo	char(3)	not null,
descripcion	char(60)	null,
constraint pk PRIMARY KEY  NONCLUSTERED ( codigo)
)
...
SETUSER
go
print    'formacion_tipo_conv'
SETUSER 'dbo'
go
create table dbo.formacion_tipo_conv (
cod_tipo	char(3)	not null,
descripcion	char(150)	null,
cod_clasificacion	char(3)	null,
facturable	char(1)	null,
constraint cod_tipo PRIMARY KEY  NONCLUSTERED ( cod_tipo)
)
on 'default'
go
...
SETUSER
go
print    'formacion_tipo_conv_clasi'
SETUSER 'dbo'
go
create table dbo.formacion_tipo_conv_clasi (
cod_clasificacion	char(3)	not null,
descripcion	char(100)	null,
constraint cod_clasificacion PRIMARY KEY  NONCLUSTERED ( cod_clasificacion)
)
on 'default'
go
...
SETUSER
go
print    'formacion_tipos_documentos'
SETUSER 'dbo'
go
create table dbo.formacion_tipos_documentos (
codigo	char(2)	not null,
descripcion	char(255)	null,
constraint pk PRIMARY KEY  NONCLUSTERED ( codigo)
)
...
SETUSER
go
print    'formacion_titulacion'
SETUSER 'dbo'
go
create table dbo.formacion_titulacion (
cod_titulacion	nvarchar(3)	not null,
descripcion	nvarchar(255)	null,
constraint cod_titulacion PRIMARY KEY  NONCLUSTERED ( cod_titulacion)
)
on 'default'
go
...
SETUSER
go
print    'formacion_valoracion'
SETUSER 'dbo'
go
create table dbo.formacion_valoracion (
codigo	char(2)	not null,
descripcion	char(60)	null,
constraint formacion_valoracion PRIMARY KEY  NONCLUSTERED (codigo)
)
on 'default'
go
...
codigo	char(10)	not null,
observaciones	text	null,
constraint incidencias PRIMARY KEY  NONCLUSTERED ( id_incidencias, exp, fecha, codigo)
)
on 'default'
go
print   'exp'
...
observaciones	text	null,
usuario	char(10)	null,
constraint incidencias_fases PRIMARY KEY  NONCLUSTERED (id_incidencias, id_fase,fecha,codigo)
)
on 'default'
go
print   'id_fase'
...
SETUSER 'dbo'
go
create table dbo.ivajulio2010 (
estado	varchar(1)	not null
constraint pk_ivajulio primary key clustered (estado) 
)
...
sig	char(100)	null,
encuadernacion	char(100)	null,
num_paginas	float	null,
isbn_13	char(30)	null,
constraint libros_copy_x PRIMARY KEY  NONCLUSTERED ( id_libro)
)
on 'default'
go
...
orden	char(2)	null,
activo	char(1)	null,
constraint listados_x PRIMARY KEY  NONCLUSTERED ( dw,ventana,descripcion)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.listados_aux (
descripcion	char(100)	not null,
dw	char(100)	not null,
ventana	char(50)	not null,
orden	char(2)	null,
activo	char(1)	null,
constraint listados_x PRIMARY KEY  NONCLUSTERED ( dw,ventana)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.listados_real (
descripcion	char(100)	not null,
dw	char(100)	not null,
ventana	char(50)	not null,
orden	char(2)	null,
activo	char(1)	null,
constraint listados_x PRIMARY KEY  NONCLUSTERED ( descripcion,dw,ventana)
)
on 'default'
go
...
constraint PK_TAG PRIMARY KEY  CLUSTERED ( tag)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.messages_ca_2 (
tag	varchar(250)	not null,
traduccion	varchar(250)	not null,
modulo	varchar(250)	not null,
nombre	varchar(250)	not null,
constraint messages_ca_x PRIMARY KEY  NONCLUSTERED ( tag)
)
on 'default'
go
...
SETUSER
go
print    'minutas_nuevas'
SETUSER 'dbo'
go
create table dbo.minutas_nuevas (
id_minuta	char(10)	not null,
id_fase	char(10)	not null,
constraint minutas_nuevas_x PRIMARY KEY  NONCLUSTERED ( id_minuta)
)
on 'default'
go
...
print   'id_colegiado'
create nonclustered index id_colegiado
on dbo.modificaciones (id_colegiado)
on 'default'
go
...
src_poliza_plus	char(1)	DEFAULT  'N' null	null,
constraint musaat_copy_x PRIMARY KEY  NONCLUSTERED ( id_musaat)
)
on 'default'
go
print   'id_col'
...
src_recargo	decimal(3, 2)	DEFAULT  1.00 null	null,
src_recargo_1	decimal(3, 2)	DEFAULT  1.00 NULL	null,
cod_colegio_dest	char(2)	null,
obra_iniciada	char(1)	DEFAULT  'N' 	null,
...
constraint musaat_movimientos PRIMARY KEY  NONCLUSTERED (id_movimiento )
)
on 'default'
go
...
SETUSER
go
print    'musaat_params_linea_fe'
SETUSER 'dbo'
go
create table dbo.musaat_params_linea_fe (
id_musaat	char(10)	not null,
...
porcentaje	float	null,
base_musaat	float	null,
pirma_total	float	null,
prima_total	float	null,
id_fase	char(10)	null,
id_col	char(10)	null,
constraint musaat_params_linea_fe PRIMARY KEY  NONCLUSTERED (id_musaat )
)
on 'default'
go
...
constraint notificaciones PRIMARY KEY  NONCLUSTERED (nombre)
)
on 'default'
go
...
zona	char(3)	null,
constraint poblaciones PRIMARY KEY  NONCLUSTERED (cod_pob,cod_pos )
)
on 'default'
go
print   'cod_pos'
...
empresa	char(2)	not null,
constraint pk_serie PRIMARY KEY  NONCLUSTERED ( codigo,empresa,cod_delegacion)
)
on 'default'
go
...
SETUSER
go
print    'registro_series2'
SETUSER 'dbo'
go
create table dbo.registro_series2 (
codigo	char(10)	not null,
descripcion	char(100)	null,
cod_delegacion	char(2)	not null,
contador	float	null,
...
cod_aplicacion	char(10)	null,
empresa	char(2)	null,
constraint pk_serie PRIMARY KEY  NONCLUSTERED ( codigo,cod_delegacion)
)
on 'default'
go
...
constraint pk_regsoc PRIMARY KEY  NONCLUSTERED ( id_regsoc)
)
on 'default'
go
...
referencia_tpv	char(40)	null,
empresa	char(2)	null,
constraint n_remesa PRIMARY KEY  NONCLUSTERED ( n_remesa)
)
on 'default'
go
...
n_visado	char(10)	not null,
rcvvisado	char(10)	not null,
impo	float	not null,
constraint pk_nvisado PRIMARY KEY  CLUSTERED ( n_visado)
)
on 'default'
go
...
constraint t_control_eventos_x PRIMARY KEY  NONCLUSTERED ( id_control)
)
on 'default'
go
...
codigo	char(10)	not null,
descripcion	char(50)	null,
constraint pk_laboratorio PRIMARY KEY  NONCLUSTERED ( codigo)
)
on 'default'
go
...
id_tramite	char(10)	not null,
nombre_tramite	char(100)	not null,
constraint pk_id_tramite PRIMARY KEY  CLUSTERED ( id_tramite)
)
on 'default'
go
...
SETUSER
go
print    'tarifas_coeficientes'
SETUSER 'dbo'
go
create table dbo.tarifas_coeficientes (
...
constraint pk_t_coef PRIMARY KEY  NONCLUSTERED ( id)
)
on 'default'
go
...
SETUSER
go
print    'tarifas_importes'
SETUSER 'dbo'
go
create table dbo.tarifas_importes (
id	varchar(10)	not null,
id_tarifa	varchar(10)	null,
id_informe	varchar(10)	null,
precio_base	float	null,
coef_modificador	float	null,
constraint pk_id_tarifa_informe PRIMARY KEY  NONCLUSTERED ( id)
)
on 'default'
go
...
SETUSER
go
print    'tarifas_informes_x_tramite'
SETUSER 'dbo'
go
create table dbo.tarifas_informes_x_tramite (
id	varchar(10)	not null,
tipo_tramite	varchar(10)	null,
visared	varchar(1)	null,
id_informe	varchar(10)	null,
colegio	varchar(10)	null,
aplica_parti	char(1)	DEFAULT  'S' null	null,
...
SETUSER
go
print    'tarifas_superficie'
SETUSER 'dbo'
go
create table dbo.tarifas_superficie (
id	varchar(10)	not null,
sup_desde	float	null,
sup_hasta	float	null,
coeficiente	float	null,
colegio	varchar(10)	null,
constraint pk_sup PRIMARY KEY  CLUSTERED ( id)
)
on 'default'
go
...
SETUSER
go
print    'tarifas_tipo_act'
SETUSER 'dbo'
go
create table dbo.tarifas_tipo_act (
...
colegio	varchar(10)	null,
constraint pl PRIMARY KEY  CLUSTERED ( id_tarifa)
)
on 'default'
go
...
SETUSER
go
print    'tarifas_tipo_obra'
SETUSER 'dbo'
go
create table dbo.tarifas_tipo_obra (
id	varchar(10)	not null,
tipo_obra	varchar(3)	null,
coeficiente	float	null,
colegio	varchar(10)	null,
constraint pk_tipo_obra PRIMARY KEY  CLUSTERED ( id)
)
on 'default'
go
...
constraint id_tipo_envio_x PRIMARY KEY  CLUSTERED ( id_tipo_envio)
)
on 'default'
go
...
impresora	char(100)	null,
bandeja	char(2)	null,
constraint pk_tipos_facturas PRIMARY KEY  CLUSTERED ( codigo)
)
on 'default'
go
print   'i_cod'
create unique nonclustered index i_cod
on dbo.tipos_facturas (codigo)
on 'default'
go
...
modificable	char(1)	null,
constraint var_globales_copy_x PRIMARY KEY  NONCLUSTERED ( nombre)
)
on 'default'
go
...
SETUSER
go
print    'web_colegiados'
SETUSER 'dbo'
go
create table dbo.web_colegiados (
id_web	nvarchar(10)	not null,
id_colegiado	nvarchar(10)	not null,
titulo	nvarchar(50)	not null,
logo	nvarchar(100)	not null,
mail	nvarchar(100)	not null,
nombre_web	nvarchar(255)	null,
constraint PK_id_web PRIMARY KEY  NONCLUSTERED ( id_web)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.web_estilos (
id_estilo	nvarchar(10)	not null,
...
constraint web_estilos_x PRIMARY KEY  NONCLUSTERED ( id_estilo)
)
on 'default'
go
...
SETUSER 'dbo'
go
create table dbo.web_paginas (
id_pagina	nvarchar(10)	not null,
id_web	nvarchar(10)	not null,
...
constraint web_paginas_x PRIMARY KEY  NONCLUSTERED ( id_pagina)
)
on 'default'
go
...
SETUSER
go
print    'web_plantillas'
SETUSER 'dbo'
go
create table dbo.web_plantillas (
id_plantilla	nvarchar(10)	not null,
descripcion	nvarchar(150)	null,
contenido	text	null,
...
constraint web_plantillas_x PRIMARY KEY  NONCLUSTERED ( id_plantilla)
)
on 'default'
go
...
alter table dbo.consultas_datos 
add constraint dbo.fk_consulta_reference_consulta foreign key (id_consulta) references sicap_mallorca.dbo.consultas(id_consulta)
go
alter table dbo.t_grupo_permisos 
add constraint dbo.fk_t_grupo__reference_t_aplica foreign key (cod_aplicacion) references sicap_mallorca.dbo.t_aplicacion(cod_aplicacion)
alter table dbo.t_grupo_permisos 
add constraint dbo.fk_t_grupo__reference_t_grupo foreign key (cod_grupo) references sicap_mallorca.dbo.t_grupo(cod_grupo)
go
alter table dbo.t_usuario_grupos 
add constraint dbo.fk_t_usuari_reference_t_usuari foreign key (cod_usuario) references sicap_mallorca.dbo.t_usuario(cod_usuario)
alter table dbo.t_usuario_grupos 
add constraint dbo.fk_t_usuari_reference_t_grupo foreign key (cod_grupo) references sicap_mallorca.dbo.t_grupo(cod_grupo)
go

print    'expedi_pto_seg'
SETUSER  'dbo'
go

CREATE VIEW expedi_pto_seg  
    ( id_expedi,   
      n_expedi,   
      fase,   
      pres_seguridad,   
...
print    'fases_seg_pres'
SETUSER  'dbo'
go

CREATE VIEW fases_seg_pres  
    ( fase,   
      id_fase,   
      pres_seguridad ) AS   
  SELECT fases.fase,   
...
create VIEW fases_visats  
  ...
  SELECT visats.id,   
         visats.vis_numero,   
         visats.vis_promotor1,   
         visats.vis_promotor2,   
         visats.vis_promotor3,   
         visats.vis_representant,   
         visats.vis_rep_nif,   
  visats.vis_rep_qualitat,   
         visats.vis_data,   
         fases.id_expedi,   
         fases.id_fase,   
         fases.n_registro,   
         ...
         fases.usuario,   
         fases.aplicado_10,   
         fases.n_registro_visared,   
         fases.n_expedi_visared,   
         fases.porc_honorarios,   
         fases.paga_gastos_cliente,   
 fases.num_coac,   
         fases.f_visado_coac,   
         fases.fa,   
         fases.tipo_registro,   
         fases.n_contrato_ant,   
         fases.n_consejo_fase,   
         fases.destino_int,   
         fases.piso,   
         fases.puerta  
    FROM visats,   
...
create VIEW fases_visats2  
 ...
 puerta ) AS   
  ...
  fases.num_coac,   
    ...
    FROM visats,   
         fases
where visats.id_fase1 not in (select fases.id_fase from fases) 
go

SETUSER
go

print    'minutas_ficticios'
SETUSER  'dbo'
go

create view minutas_ficticios as select id_minuta,id_fase from fases_minutas where id_cliente='FICTICIO'
go
...
create view vwCliente (id,nombre, apellidos, nif, f_nacimiento, email, sexto, tipo_via, nom_via, cp, cod_pob, tel, movil)
as
                                                                                     
                                                                                             
        
select id_cliente as id, nombre, apellidos, nif,  '' as f_nacimiento, email, sexo, tipo_via, nombre_via as nom_via, cp, cod_pob, telefono as te, '' as movill from clientes
...
create view vwColegiado (id,nombre, apellidos, nif, f_nacimiento, email, sexto, tipo_via, nom_via, cp, cod_pob, tel, movil)
as
select colegiados.id_colegiado as id, nombre, apellidos, nif, f_nacimiento, email,
