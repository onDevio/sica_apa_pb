...
Echo database=
set /p database=
if "%database%"=="" set database=sicap02
...
if %menup%==15 set ruta_base=..\src\resources\COAAT_Rioja
...
if %menup%==19 set ruta_base=C:\ondevio_projects\sicap_trunk\src\resources\COAAT_Teruel
if %menup%==20 set ruta_base=C:\ondevio_projects\sicap_trunk\src\resources\COAAT_Zaragoza
...
::rem echo %ruta_base%
::echo %ruta_base%
echo borrado de tablas
:borrado tablas
::ECHO dump tran %database% with truncate_only >> borrar_tablas_config.sql
::MORE borrar_tablas_config_temp.sql >> borrar_tablas_config.sql
::ECHO dump tran %database% with truncate_only >> borrar_tablas_config.sql
::echo go >>borrar_tablas_config.sql
isql -U%user% -P%password% -S %server% >> log.txt -D%database% < borrar_tablas_config.sql

echo Realizando insert de tablas básicas
isql -U%user% -P%password% -S %server%  >> log.txt -D%database% < insert.sql 


::bcp sicap01..contadores in C:\ondevio_projects\sicap_trunk\src\resources\COAAT_Teruel\Carga_datos_BD\contadores.txt -c -e contadores_error.txt -Usa -POndevio7 -S ucp-tst-02 >> log.txt

echo bcp de tablas
:in

::bcp %database%..almacen_almacenes in %ruta_base%almacen_almacenes.txt -c -e error.txt -e error.txt -U%user% -P%password% -S %server% >> log.txt  
::echo almacen_almacenes >>log.txt
::bcp %database%..almacen_tipos in %ruta_base%almacen_tipos.txt -c -e almacen_tipos_error.txt -U%user% -P%password% -S %server% >> log.txt 
::bcp %database%..asesoria_juridica_medio in %ruta_base%asesoria_juridica_medio.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..asesoria_juridica_procedencia in %ruta_base%asesoria_juridica_procedencia.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..asesoria_tipo_asuntos in %ruta_base%asesoria_tipo_asuntos.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..bt_idiomas in %ruta_base%bt_idiomas.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..bt_nivel in %ruta_base%bt_nivel.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..bt_tipo_bolsa in %ruta_base%bt_tipo_bolsa.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..bt_demandas_tipo in %ruta_base%bt_demandas_tipo.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
echo bt_demandas_tipo >>log.txt
bcp %database%..c_geograficos in %ruta_base%c_geograficos.txt -c -e c_geograficos_error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..cabecera in %ruta_base%cabecera.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..callejero in %ruta_base%callejero.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..cargos in %ruta_base%cargos.txt -c -e cargos_error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..cartas in %ruta_base%cartas.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..cierre in %ruta_base%cierre.txt -c -e cierre_error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..cip_tablas in %ruta_base%cip_tablas.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..cip_tarifa in %ruta_base%cip_tarifa.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..cip_tipo_act in %ruta_base%cip_tipo_act.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
bcp %database%..ciudades in %ruta_base%ciudades.txt -c -e ciudades_error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..coaatll_dip in %ruta_base%coaatll_dip.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..coef_ipc in %ruta_base%coef_ipc.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::echo Tarifas COAATMallorca >>log.txt
::bcp %database%..coaatmca_coef_b in %ruta_base%coaatmca_coef_b.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..coaatmca_coef_c in %ruta_base%coaatmca_coef_c.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..coaatmca_coeficientes in %ruta_base%coaatmca_coeficientes.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..coaatmca_dv in %ruta_base%coaatmca_dv.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
::bcp %database%..coaatmca_tipologia_edif in %ruta_base%coaatmca_tipologia_edif.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
...
bcp %database%..csi_empresas_logos in %ruta_base%csi_empresas_logos.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
...
bcp %database%..csi_prorrata_empresa in %ruta_base%csi_prorrata_empresa.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
...
echo expedientes_estado >>log.txt
...
bcp %database%..t_mensaje in %ruta_base%t_mensaje.txt -c -e error.txt -U%user% -P%password% -S %server% >> log.txt
