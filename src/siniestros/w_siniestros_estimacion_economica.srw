HA$PBExportHeader$w_siniestros_estimacion_economica.srw
forward
global type w_siniestros_estimacion_economica from w_mant_simple
end type
end forward

global type w_siniestros_estimacion_economica from w_mant_simple
string title = "Mantenimiento de Estimaci$$HEX1$$f300$$ENDHEX$$n Econ$$HEX1$$f300$$ENDHEX$$mica"
end type
global w_siniestros_estimacion_economica w_siniestros_estimacion_economica

on w_siniestros_estimacion_economica.create
call super::create
end on

on w_siniestros_estimacion_economica.destroy
call super::destroy
...
type dw_1 from w_mant_simple`dw_1 within w_siniestros_estimacion_economica
integer width = 2953
string dataobject = "d_estimacion_economica"
end type
...
// Comprobamos que no hayan siniestros que utilicen este c$$HEX1$$f300$$ENDHEX$$digo
   ...
   WHERE (fases_siniestros.estimacion = :codigo) ;  
...
type cb_anyadir from w_mant_simple`cb_anyadir within w_siniestros_estimacion_economica
end type

type cb_borrar from w_mant_simple`cb_borrar within w_siniestros_estimacion_economica
end type

type cb_ayuda from w_mant_simple`cb_ayuda within w_siniestros_estimacion_economica
end type
