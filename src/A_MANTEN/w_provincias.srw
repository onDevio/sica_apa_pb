...
$PBExportComments$domicilio,clientes
forward
global type w_provincias from w_mant_simple
end type
end forward
...
mensaje += f_valida(dw_1,'cod_provincia','NOVACIO',g_idioma.of_getmsg('general.campo_codigo','Debe especificar un valor en el campo C$$HEX1$$f300$$ENDHEX$$digo.')+cr)
mensaje += f_valida(dw_1,'cod_pais','NOVACIO',g_idioma.of_getmsg('colegiados.campo_pais','Debe especificar un valor en el campo Pa$$HEX1$$ed00$$ENDHEX$$s.')+cr)
...
type cb_recuperar_pantalla from w_mant_simple`cb_recuperar_pantalla within w_provincias
end type

type cb_guardar_pantalla from w_mant_simple`cb_guardar_pantalla within w_provincias
end type

type dw_1 from w_mant_simple`dw_1 within w_provincias
integer width = 1842
string dataobject = "d_mant_provincias"
end type
...
fila = dw_1.GetRow()
codigo = dw_1.GetItemString(fila, "cod_provincia")
...
type cb_anyadir from w_mant_simple`cb_anyadir within w_provincias
end type

type cb_borrar from w_mant_simple`cb_borrar within w_provincias
end type

type cb_ayuda from w_mant_simple`cb_ayuda within w_provincias
end type
