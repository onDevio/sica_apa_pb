HA$PBExportHeader$w_contabil_articulos_busqueda.srw
$PBExportComments$lineas_facturas_emitidas, colegiados
forward
global type w_contabil_articulos_busqueda from w_mant_simple
end type
type dw_2 from u_dw within w_contabil_articulos_busqueda
end type
type cb_aceptar from commandbutton within w_contabil_articulos_busqueda
end type
type cb_cancelar from commandbutton within w_contabil_articulos_busqueda
end type
end forward
...
global w_contabil_articulos_busqueda w_contabil_articulos_busqueda
...
on w_contabil_articulos_busqueda.create
int iCurrent
call super::create
...
on w_contabil_articulos_busqueda.destroy
call super::destroy
destroy(this.dw_2)
...
type cb_recuperar_pantalla from w_mant_simple`cb_recuperar_pantalla within w_contabil_articulos_busqueda
end type

type cb_guardar_pantalla from w_mant_simple`cb_guardar_pantalla within w_contabil_articulos_busqueda
integer x = 622
integer y = 1088
integer taborder = 20
end type

type dw_1 from w_mant_simple`dw_1 within w_contabil_articulos_busqueda
integer x = 37
integer y = 608
integer width = 3803
integer height = 512
integer taborder = 70
string dataobject = "d_mant_articulos_consulta_lista_multi"
...
type cb_anyadir from w_mant_simple`cb_anyadir within w_contabil_articulos_busqueda
...
type cb_borrar from w_mant_simple`cb_borrar within w_contabil_articulos_busqueda
boolean visible = false
integer taborder = 60
boolean enabled = false
end type

type cb_ayuda from w_mant_simple`cb_ayuda within w_contabil_articulos_busqueda
boolean visible = false
integer taborder = 30
end type
