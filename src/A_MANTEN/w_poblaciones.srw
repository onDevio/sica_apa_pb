HA$PBExportHeader$w_poblaciones.srw
$PBExportComments$domicilio,cliente,fases,registrosE/S,arquitectos, expedientes, formacion
forward
global type w_poblaciones from w_mant_simple
end type
type dw_busqueda from u_dw within w_poblaciones
end type
type dw_temporal from u_dw within w_poblaciones
end type
end forward
...
integer width = 3973
integer height = 2032
string title = "Mantenimiento de Poblaciones"
dw_busqueda dw_busqueda
dw_temporal dw_temporal
end type
global w_poblaciones w_poblaciones

type variables
string i_sql_nuevo
end variables

on w_poblaciones.create
int iCurrent
call super::create
...
type cb_recuperar_pantalla from w_mant_simple`cb_recuperar_pantalla within w_poblaciones
end type

type cb_guardar_pantalla from w_mant_simple`cb_guardar_pantalla within w_poblaciones
end type

type dw_1 from w_mant_simple`dw_1 within w_poblaciones
integer x = 37
integer y = 456
integer width = 3863
integer height = 1224
...
type cb_anyadir from w_mant_simple`cb_anyadir within w_poblaciones
integer x = 37
integer y = 1704
end type

type cb_borrar from w_mant_simple`cb_borrar within w_poblaciones
integer x = 329
integer y = 1704
end type

type cb_ayuda from w_mant_simple`cb_ayuda within w_poblaciones
integer x = 1358
integer y = 1704
end type
...
string dataobject = "d_poblaciones_busqueda"
...
choose case dwo.name
	case 'cb_buscar'
		...
		f_sql('poblaciones.cod_pos','LIKE','cod_pos',dw_busqueda,i_sql_nuevo,'1','')
		f_sql('poblaciones.descripcion','LIKE','descripcion',dw_busqueda,i_sql_nuevo,'1','')
		f_sql('poblaciones.provincia','=','provincia',dw_busqueda,i_sql_nuevo,'1','')
		f_sql('poblaciones.pob_mopu','=','pob_mopu',dw_busqueda,i_sql_nuevo,'1','')
		f_sql('poblaciones.zona','=','zona',dw_busqueda,i_sql_nuevo,'1','')
//		f_sql('poblaciones.tipo','=','tipo',dw_busqueda,i_sql_nuevo,'1','')
