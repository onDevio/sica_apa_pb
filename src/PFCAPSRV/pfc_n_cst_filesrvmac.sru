...
do 
	ll_pos = PosA(as_filespec, ":", ll_pos +1 ) 
	if ll_pos > 0 then ll_pos_temp = ll_pos
loop  while  ll_pos > 0 

ls_filespec = MidA(as_filespec, 1, ll_pos_temp)
...
lstr_SystemTime.ui_wMilliseconds = Long(RightA(ls_Time, 6))
