...
If ll_StrLen > 32765 Then
	ls_Text1 = LeftA(as_Text, 32765)
	ls_Text2 = RightA(as_Text, (ll_StrLen - 32765))
Else
	ls_Text1 = as_Text
End if
...
For li_Cnt = 1 To li_Entries
	If lnv_DirList[li_Cnt].ib_SubDirectory Then
		...
		If lnv_DirList[li_Cnt].is_FileName <> "[..]" Then
			...
			ls_SubDirectory = MidA(lnv_DirList[li_Cnt].is_FileName, 2, &
				(LenA(lnv_DirList[li_Cnt].is_FileName) - 2))
...
long retorno
retorno=CopyFile(as_sourcefile,as_targetfile,0)

if retorno=1 then return 1
if retorno=0 then return -2
