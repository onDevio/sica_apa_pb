HA$PBExportHeader$w_calculo_honorarios_cc.srw
$PBExportComments$Heredada de la ventana de Cuenca
forward
global type w_calculo_honorarios_cc from w_calculo_honorarios
end type
type cb_4 from commandbutton within w_calculo_honorarios_cc
end type
type dw_2 from u_dw within w_calculo_honorarios_cc
end type
end forward
...
integer width = 3282
integer height = 1952
string title = "C$$HEX1$$e100$$ENDHEX$$lculo de Costes"
event csd_recalcular ( )
cb_4 cb_4
dw_2 dw_2
end type
global w_calculo_honorarios_cc w_calculo_honorarios_cc
...
on w_calculo_honorarios_cc.create
int iCurrent
call super::create
...
if i_st_hon.ca = 0 then
	dw_1.setitem(1, 'ca', g_ca)
else
	dw_1.setitem(1, 'ca', i_st_hon.ca)
end if
...
ds_datos.DataObject = 'd_fases_cip_cc'
...
type cb_recuperar_pantalla from w_calculo_honorarios`cb_recuperar_pantalla within w_calculo_honorarios_cc
integer x = 3287
integer y = 1820
integer taborder = 0
end type

type cb_guardar_pantalla from w_calculo_honorarios`cb_guardar_pantalla within w_calculo_honorarios_cc
integer x = 3287
integer y = 1724
integer taborder = 0
end type

type cb_3 from w_calculo_honorarios`cb_3 within w_calculo_honorarios_cc
integer x = 1605
integer y = 1708
integer width = 407
integer taborder = 60
...
type cb_2 from w_calculo_honorarios`cb_2 within w_calculo_honorarios_cc
integer y = 1708
integer taborder = 50
end type
...
i_ds_hon.DataObject = 'd_calculo_honorarios_cc'
...
type cb_1 from w_calculo_honorarios`cb_1 within w_calculo_honorarios_cc
integer x = 485
integer y = 1120
integer taborder = 40
end type
...
st_hon.ca					= dw_1.getitemnumber(1, 'ca')
...
type dw_1 from w_calculo_honorarios`dw_1 within w_calculo_honorarios_cc
event csd_ocultar_campos ( )
integer width = 3150
integer height = 1628
string dataobject = "d_calculo_honorarios_cc"
end type
...
CHOOSE CASE dwo.name
	CASE 'tarifa'
		event csd_ocultar_campos()
		f_inicializar_valores_st_honteor_dat_cc (parent)
		...
		CHOOSE CASE data
			...
			CASE '1101' //CASE '18'
				...
				dw_2.object.superficie_t.visible = true
				cb_4.visible = true
			CASE '1033','1034','1035','1036','1038','1037', '1104', '1106'  //CASE '20'
				...
				cb_4.visible = true
		END CHOOSE
		post f_parametriza_ventana_calculo_honos_cc(parent)
	CASE 'contenido'
		event csd_ocultar_campos()
		CHOOSE CASE data
			CASE 'EG', 'RP', 'DO', 'DEO'
...
// Calculamos los honorarios
f_calcular_pem_min_cc(st_hon)

// Visualizamos los resultados
dw_1.setitem(1, 'pem_min', st_hon.pem_min)
// EL PEM minimo es solo indicativo. No se usa para calcular
...
integer taborder = 20
boolean bringtotop = true
string dataobject = "d_calculo_pem_min_cc"
...
choose case dwo.name
	...
	case 'b_usos'
		...
		openwithparm(w_pem_minimo_usos,i_id_fase)		
		res = message.doubleparm
