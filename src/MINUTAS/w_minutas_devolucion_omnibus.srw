HA$PBExportHeader$w_minutas_devolucion_omnibus.srw
forward
global type w_minutas_devolucion_omnibus from w_response
end type
type dw_3 from u_dw within w_minutas_devolucion_omnibus
end type
type st_proceso from statictext within w_minutas_devolucion_omnibus
end type
type st_1 from statictext within w_minutas_devolucion_omnibus
end type
type cb_aumentar from commandbutton within w_minutas_devolucion_omnibus
end type
type cb_disminuir from commandbutton within w_minutas_devolucion_omnibus
end type
type sle_imprimir_copias from singlelineedit within w_minutas_devolucion_omnibus
end type
type st_3 from statictext within w_minutas_devolucion_omnibus
end type
type st_2 from statictext within w_minutas_devolucion_omnibus
end type
type sle_imprimir_originales from singlelineedit within w_minutas_devolucion_omnibus
end type
type cb_disminuir_copias from commandbutton within w_minutas_devolucion_omnibus
end type
type cb_aumentar_copias from commandbutton within w_minutas_devolucion_omnibus
end type
type cb_1 from commandbutton within w_minutas_devolucion_omnibus
end type
type cb_2 from commandbutton within w_minutas_devolucion_omnibus
end type
type dw_2 from u_dw within w_minutas_devolucion_omnibus
end type
type dw_fact from u_dw within w_minutas_devolucion_omnibus
end type
type dw_4 from u_dw within w_minutas_devolucion_omnibus
end type
type dw_1 from u_dw within w_minutas_devolucion_omnibus
end type
type dw_historico from u_csd_dw within w_minutas_devolucion_omnibus
end type
type dw_5 from datawindow within w_minutas_devolucion_omnibus
end type
end forward
...
global w_minutas_devolucion_omnibus w_minutas_devolucion_omnibus
...
on w_minutas_devolucion_omnibus.create
int iCurrent
call super::create
...
on w_minutas_devolucion_omnibus.destroy
call super::destroy
destroy(this.dw_3)
...
type cb_recuperar_pantalla from w_response`cb_recuperar_pantalla within w_minutas_devolucion_omnibus
integer x = 2533
integer y = 1376
integer taborder = 0
end type

type cb_guardar_pantalla from w_response`cb_guardar_pantalla within w_minutas_devolucion_omnibus
integer x = 2533
integer y = 1236
integer taborder = 0
end type
...
if lower(dw_1.describe("id_renuncia.name")) = 'id_renuncia' then 
	...
	if t_visado = '6' then//Actualiza el N$$HEX1$$fa00$$ENDHEX$$mero de renuncia
		...
		observaciones='N$$HEX2$$ba002000$$ENDHEX$$Renuncia:'+n_renuncia+". "+observaciones
	end if
...
if total_aviso = 0 then
	...
	if g_colegio = 'COAATCC' then porc_renuncia=porc_realizado_musaatcc
...
event csd_rellenar_descuentos();string id_col, id_fase, id_cliente, id_expedi
...
string cliente_colegiado, tipo_act, id_exp
...
id_col = dw_1.getitemstring(1, 'id_colegiado')
id_fase = i_w.dw_1.getitemstring(1, 'id_fase')
//id_expedi = i_w.dw_1.getitemstring(1, 'id_expedi')
porc_renuncia = this.getitemnumber(1, 'porc_renuncia')
porc_realizado = f_redondea ( 100 - porc_renuncia )

dw_5.SetTransObject(sqlca)
dw_5.Retrieve(id_fase,id_col,porc_realizado, cliente_colegiado)

fila = dw_5.insertrow(0)
dw_5.SetItem(fila,'descripcion','Gastos de tramitaci$$HEX1$$f300$$ENDHEX$$n:')
//dw_5.Modify(
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_fases_renuncias_descuentos"
