HA$PBExportHeader$w_eimporta_busqueda_clientes.srw
forward
global type w_eimporta_busqueda_clientes from w_busqueda
end type
type dw_3 from u_dw within w_eimporta_busqueda_clientes
end type
end forward
...
global w_eimporta_busqueda_clientes w_eimporta_busqueda_clientes

type variables
string sql
end variables

on w_eimporta_busqueda_clientes.create
int iCurrent
call super::create
...
on w_eimporta_busqueda_clientes.destroy
call super::destroy
destroy(this.dw_3)
end on

event open;call super::open;st_visared_busqueda st_datos
string nif,t_tercero

st_datos=message.PowerObjectParm


nif=st_datos.nif_cliente
t_tercero=st_datos.t_tercero

if t_tercero<> '' then
	dw_3.setitem(1,'t_tercero',t_tercero)	
end if
...
type cb_recuperar_pantalla from w_busqueda`cb_recuperar_pantalla within w_eimporta_busqueda_clientes
string tag = "texto=general.recuperar_pantalla"
end type

type cb_guardar_pantalla from w_busqueda`cb_guardar_pantalla within w_eimporta_busqueda_clientes
string tag = "texto=general.guardar_pantalla"
end type

type sle_1 from w_busqueda`sle_1 within w_eimporta_busqueda_clientes
end type

type dw_2 from w_busqueda`dw_2 within w_eimporta_busqueda_clientes
integer x = 832
integer y = 544
integer width = 1975
integer height = 92
...
type st_1 from w_busqueda`st_1 within w_eimporta_busqueda_clientes
string tag = "texto=clientes.paramtero_completo"
end type

type st_2 from w_busqueda`st_2 within w_eimporta_busqueda_clientes
...
type cb_1 from w_busqueda`cb_1 within w_eimporta_busqueda_clientes
integer y = 1776
integer width = 594
integer taborder = 70
end type
...
type cb_2 from w_busqueda`cb_2 within w_eimporta_busqueda_clientes
integer y = 1776
integer taborder = 80
boolean default = true
end type

type dw_1 from w_busqueda`dw_1 within w_eimporta_busqueda_clientes
integer x = 37
integer y = 676
integer width = 2894
integer height = 1040
