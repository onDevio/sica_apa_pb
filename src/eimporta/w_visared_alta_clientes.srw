HA$PBExportHeader$w_visared_alta_clientes.srw
forward
global type w_visared_alta_clientes from w_response
end type
type cb_1 from commandbutton within w_visared_alta_clientes
end type
type cb_aceptar from commandbutton within w_visared_alta_clientes
end type
type dw_3 from u_dw within w_visared_alta_clientes
end type
type dw_tipos_clientes from u_dw within w_visared_alta_clientes
end type
end forward
...
integer width = 2592
integer height = 1632
string title = "Alta Clientes VISARED"
cb_1 cb_1
cb_aceptar cb_aceptar
dw_3 dw_3
dw_tipos_clientes dw_tipos_clientes
end type
global w_visared_alta_clientes w_visared_alta_clientes
...
string tipo_tercero = '01'
//if datos_cliente.cuenta_banco = 'R' then tipo_tercero = '23' else tipo_tercero = '01'
...
on w_visared_alta_clientes.create
int iCurrent
call super::create
...
on w_visared_alta_clientes.destroy
call super::destroy
destroy(this.cb_1)
...
type cb_recuperar_pantalla from w_response`cb_recuperar_pantalla within w_visared_alta_clientes
end type

type cb_guardar_pantalla from w_response`cb_guardar_pantalla within w_visared_alta_clientes
end type
...
g_campos_subsanados.cli_nif[il_numero_cli]=dw_3.GetItemString(dw_3.Getrow(),'nif')
