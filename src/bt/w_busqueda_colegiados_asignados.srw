HA$PBExportHeader$w_busqueda_colegiados_asignados.srw
forward
global type w_busqueda_colegiados_asignados from w_busqueda
end type
type dw_3 from u_dw within w_busqueda_colegiados_asignados
end type
end forward
...
global w_busqueda_colegiados_asignados w_busqueda_colegiados_asignados

type variables
string sql, i_tipo_demanda
end variables

on w_busqueda_colegiados_asignados.create
int iCurrent
call super::create
...
on w_busqueda_colegiados_asignados.destroy
call super::destroy
destroy(this.dw_3)
end on
...
type cb_recuperar_pantalla from w_busqueda`cb_recuperar_pantalla within w_busqueda_colegiados_asignados
end type

type cb_guardar_pantalla from w_busqueda`cb_guardar_pantalla within w_busqueda_colegiados_asignados
end type

type sle_1 from w_busqueda`sle_1 within w_busqueda_colegiados_asignados
end type

type dw_2 from w_busqueda`dw_2 within w_busqueda_colegiados_asignados
integer x = 832
integer y = 544
integer width = 1975
integer height = 92
...
type st_1 from w_busqueda`st_1 within w_busqueda_colegiados_asignados
end type

type st_2 from w_busqueda`st_2 within w_busqueda_colegiados_asignados
integer y = 552
integer width = 777
string text = "Apellido/Sociedad activo al teclear:"
end type

type cb_1 from w_busqueda`cb_1 within w_busqueda_colegiados_asignados
integer y = 1776
integer taborder = 70
end type
...
type cb_2 from w_busqueda`cb_2 within w_busqueda_colegiados_asignados
integer y = 1776
integer taborder = 80
end type

type dw_1 from w_busqueda`dw_1 within w_busqueda_colegiados_asignados
integer x = 37
integer y = 676
integer width = 2894
integer height = 1040
