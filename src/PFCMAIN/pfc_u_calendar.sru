...
//////////////////////////////////////////////////////////////////
// CSD -- Cambiamos los dias americanos por los espa$$HEX1$$f100$$ENDHEX$$oles
// para ellos el dia de la semana numero 1 - es domingo
// para nosotros es Lunes
   li_FirstDayNum = li_FirstDayNum - 1
   if li_FirstDaynum= 0 then li_FirstDayNum = 7
//////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////							
//CSD -Cambio el intervalo porque para mi el domingo es el dia 7
// Esto es lo que habia antes 'For li_loop = 1 to 36 step 7'
...
////////////////////////////////////////////////////////////////							
//CSD -Cambio el intervalo porque para mi el Sabado es el dia 6
// Esto es lo que habia antes 'For li_loop = 7 to 42 step 7'
For li_loop = 6 to 41 step 7
...
// CSD -- Cambiamos
If (Year(ad_date) = Year(id_resetdate) and Month(ad_date) = Month(id_resetdate)) Then

  li_year = Year(id_resetdate)
  li_month = Month(id_resetdate)
  li_day = Day(id_resetdate)
  //Obtenemos el dia de la semana en formato Europeo.
   li_FirstDayNum = DayNumber(Date(li_year, li_month, 1))
   li_FirstDayNum = li_FirstDayNum - 1
   if li_FirstDaynum= 0 then li_FirstDayNum = 7
...
event pfc_prevmonth;Integer li_month
Integer li_year
Integer li_day
