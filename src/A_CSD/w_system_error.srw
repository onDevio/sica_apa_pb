...
forward
global type w_system_error from w_response
end type
...
type cb_recuperar_pantalla from w_response`cb_recuperar_pantalla within w_system_error
end type

type cb_guardar_pantalla from w_response`cb_guardar_pantalla within w_system_error
end type
...
type cb_continue from commandbutton within w_system_error
string tag = "texto=general.continuar"
integer x = 891
integer y = 940
integer width = 430
integer height = 88
