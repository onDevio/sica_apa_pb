HA$PBExportHeader$w_mant_estados_formacion.srw
forward
global type w_mant_estados_formacion from w_mant_simple
end type
end forward
...
integer width = 2190
integer height = 1536
string title = "Mantenimiento de Estados"
end type
global w_mant_estados_formacion w_mant_estados_formacion

on w_mant_estados_formacion.create
call super::create
end on

on w_mant_estados_formacion.destroy
call super::destroy
...
mensaje += f_valida(dw_1,'cod_estado','NOVACIO','Debe especificar un valor en el campo C$$HEX1$$f300$$ENDHEX$$digo.'+cr)
...
type cb_recuperar_pantalla from w_mant_simple`cb_recuperar_pantalla within w_mant_estados_formacion
end type

type cb_guardar_pantalla from w_mant_simple`cb_guardar_pantalla within w_mant_estados_formacion
end type

type dw_1 from w_mant_simple`dw_1 within w_mant_estados_formacion
integer x = 37
integer y = 32
integer width = 2057
string dataobject = "d_mant_estados_formacion"
end type
...
type cb_anyadir from w_mant_simple`cb_anyadir within w_mant_estados_formacion
integer x = 37
end type

type cb_borrar from w_mant_simple`cb_borrar within w_mant_estados_formacion
integer x = 329
end type

type cb_ayuda from w_mant_simple`cb_ayuda within w_mant_estados_formacion
integer x = 1358
end type
