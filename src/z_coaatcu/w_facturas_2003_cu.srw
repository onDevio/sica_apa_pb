HA$PBExportHeader$w_facturas_2003_cu.srw
forward
global type w_facturas_2003_cu from w_response
end type
type dw_1 from u_dw within w_facturas_2003_cu
end type
type dw_2 from u_dw within w_facturas_2003_cu
end type
type cb_1 from commandbutton within w_facturas_2003_cu
end type
type dw_3 from u_dw within w_facturas_2003_cu
end type
type cb_2 from commandbutton within w_facturas_2003_cu
end type
type dw_4 from u_dw within w_facturas_2003_cu
end type
type st_1 from statictext within w_facturas_2003_cu
end type
end forward
...
global w_facturas_2003_cu w_facturas_2003_cu

on w_facturas_2003_cu.create
int iCurrent
call super::create
...
type cb_recuperar_pantalla from w_response`cb_recuperar_pantalla within w_facturas_2003_cu
end type

type cb_guardar_pantalla from w_response`cb_guardar_pantalla within w_facturas_2003_cu
end type
...
string dataobject = "ds_fases_minutas_sgc2003_cu"
...
for i=1 to dw_1.rowcount()
	st_1.text = string(i) + ' de ' + string(dw_1.rowcount())
	...
	dw_2.setitem(fila, 'id_factura', 'IDS' + '03' + string(i))
	...
	if dw_1.getitemnumber(i, 'base_dv')>0 then
		...
		dw_3.setitem(lin, 'id_factura', 'IDS' + '03' + string(i))
		dw_3.setitem(lin, 'id_linea', 'IDS' + '03' + string(lin))		
...
for i=1 to dw_4.rowcount()
	// HON
	st_1.text = string(i) + ' de ' + string(dw_4.rowcount())
	fila = dw_2.insertrow(0)
	...
	dw_2.setitem(fila, 'asunto', f_dame_exp(id_fase)+ ', ' + f_dame_cliente(id_cli))	
	dw_2.setitem(fila, 'obs', '')	
	dw_2.setitem(fila, 'id_factura', 'IDC1' + '03' + string(i))
	dw_2.setitem(fila, 'centro', '00')
	dw_2.setitem(fila, 'banco', '')	
	...
	if dw_4.getitemnumber(i, 'base_honos')>0 then
		lin = dw_3.insertrow(0)
		dw_3.setitem(lin, 'id_factura', 'IDC1' + '03' + string(i))
		dw_3.setitem(lin, 'id_linea', 'IDC1' + '03' + string(lin))		
	...
	dw_2.setitem(fila, 'asunto', f_dame_exp(id_fase)+ ', ' + f_dame_cliente(id_cli))	
	dw_2.setitem(fila, 'obs', '')	
	dw_2.setitem(fila, 'id_factura', 'IDC2' + '03' + string(i))
	dw_2.setitem(fila, 'centro', '00')
	dw_2.setitem(fila, 'banco', '')	
	...
	if dw_4.getitemnumber(i, 'base_dv')>0 then
		lin = dw_3.insertrow(0)
		dw_3.setitem(lin, 'id_factura', 'IDC2' + '03' + string(i))
		dw_3.setitem(lin, 'id_linea', 'IDC2' + '03' + string(lin))		
		dw_3.setitem(lin, 'descripcion', f_devuelve_desc_concepto('02'))
...
integer taborder = 10
boolean bringtotop = true
string dataobject = "ds_fases_minutas_cgc2003_cu"
boolean hscrollbar = true
boolean ib_isupdateable = false
boolean ib_rmbmenu = false
end type
